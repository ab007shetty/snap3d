 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(O,V){var D=O.length;O.push(V);e:for(;0<D;){var q=D-1>>>1,Z=O[q];if(0<a(Z,V))O[q]=V,O[D]=Z,D=q;else break e}}function n(O){return O.length===0?null:O[0]}function i(O){if(O.length===0)return null;var V=O[0],D=O.pop();if(D!==V){O[0]=D;e:for(var q=0,Z=O.length,ae=Z>>>1;q<ae;){var Re=2*(q+1)-1,Ve=O[Re],Y=Re+1,J=O[Y];if(0>a(Ve,D))Y<Z&&0>a(J,Ve)?(O[q]=J,O[Y]=D,q=Y):(O[q]=Ve,O[Re]=D,q=Re);else if(Y<Z&&0>a(J,D))O[q]=J,O[Y]=D,q=Y;else break e}}return V}function a(O,V){var D=O.sortIndex-V.sortIndex;return D!==0?D:O.id-V.id}if(t.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var r=performance;t.unstable_now=function(){return r.now()}}else{var s=Date,o=s.now();t.unstable_now=function(){return s.now()-o}}var l=[],c=[],d=1,h=null,f=3,p=!1,x=!1,S=!1,m=!1,u=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function y(O){for(var V=n(c);V!==null;){if(V.callback===null)i(c);else if(V.startTime<=O)i(c),V.sortIndex=V.expirationTime,e(l,V);else break;V=n(c)}}function R(O){if(S=!1,y(O),!x)if(n(l)!==null)x=!0,A||(A=!0,z());else{var V=n(c);V!==null&&Q(R,V.startTime-O)}}var A=!1,w=-1,N=5,T=-1;function E(){return m?!0:!(t.unstable_now()-T<N)}function L(){if(m=!1,A){var O=t.unstable_now();T=O;var V=!0;try{e:{x=!1,S&&(S=!1,g(w),w=-1),p=!0;var D=f;try{t:{for(y(O),h=n(l);h!==null&&!(h.expirationTime>O&&E());){var q=h.callback;if(typeof q=="function"){h.callback=null,f=h.priorityLevel;var Z=q(h.expirationTime<=O);if(O=t.unstable_now(),typeof Z=="function"){h.callback=Z,y(O),V=!0;break t}h===n(l)&&i(l),y(O)}else i(l);h=n(l)}if(h!==null)V=!0;else{var ae=n(c);ae!==null&&Q(R,ae.startTime-O),V=!1}}break e}finally{h=null,f=D,p=!1}V=void 0}}finally{V?z():A=!1}}}var z;if(typeof _=="function")z=function(){_(L)};else if(typeof MessageChannel<"u"){var B=new MessageChannel,I=B.port2;B.port1.onmessage=L,z=function(){I.postMessage(null)}}else z=function(){u(L,0)};function Q(O,V){w=u(function(){O(t.unstable_now())},V)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):N=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_next=function(O){switch(f){case 1:case 2:case 3:var V=3;break;default:V=f}var D=f;f=V;try{return O()}finally{f=D}},t.unstable_requestPaint=function(){m=!0},t.unstable_runWithPriority=function(O,V){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var D=f;f=O;try{return V()}finally{f=D}},t.unstable_scheduleCallback=function(O,V,D){var q=t.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?q+D:q):D=q,O){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=D+Z,O={id:d++,callback:V,priorityLevel:O,startTime:D,expirationTime:Z,sortIndex:-1},D>q?(O.sortIndex=D,e(c,O),n(l)===null&&O===n(c)&&(S?(g(w),w=-1):S=!0,Q(R,D-q))):(O.sortIndex=Z,e(l,O),x||p||(x=!0,A||(A=!0,z()))),O},t.unstable_shouldYield=E,t.unstable_wrapCallback=function(O){var V=f;return function(){var D=f;f=V;try{return O.apply(this,arguments)}finally{f=D}}}})(G0);H0.exports=G0;var $y=H0.exports,V0={exports:{}},cn={};/**
 * @license React
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,He={alphahash_fragment:kA,alphahash_pars_fragment:jA,alphamap_fragment:XA,alphamap_pars_fragment:WA,alphatest_fragment:qA,alphatest_pars_fragment:YA,aomap_fragment:ZA,aomap_pars_fragment:KA,batching_pars_vertex:QA,batching_vertex:$A,begin_vertex:JA,beginnormal_vertex:ew,bsdfs:tw,iridescence_fragment:nw,bumpmap_pars_fragment:iw,clipping_planes_fragment:aw,clipping_planes_pars_fragment:rw,clipping_planes_pars_vertex:sw,clipping_planes_vertex:ow,color_fragment:lw,color_pars_fragment:cw,color_pars_vertex:uw,color_vertex:fw,common:dw,cube_uv_reflection_fragment:hw,defaultnormal_vertex:pw,displacementmap_pars_vertex:mw,displacementmap_vertex:gw,emissivemap_fragment:vw,emissivemap_pars_fragment:_w,colorspace_fragment:xw,colorspace_pars_fragment:yw,envmap_fragment:Sw,envmap_common_pars_fragment:Mw,envmap_pars_fragment:Ew,envmap_pars_vertex:bw,envmap_physical_pars_fragment:Pw,envmap_vertex:Tw,fog_vertex:Aw,fog_pars_vertex:ww,fog_fragment:Rw,fog_pars_fragment:Cw,gradientmap_pars_fragment:Nw,lightmap_pars_fragment:Dw,lights_lambert_fragment:Uw,lights_lambert_pars_fragment:Lw,lights_pars_begin:Ow,lights_toon_fragment:zw,lights_toon_pars_fragment:Bw,lights_phong_fragment:Iw,lights_phong_pars_fragment:Fw,lights_physical_fragment:Hw,lights_physical_pars_fragment:Gw,lights_fragment_begin:Vw,lights_fragment_maps:kw,lights_fragment_end:jw,logdepthbuf_fragment:Xw,logdepthbuf_pars_fragment:Ww,logdepthbuf_pars_vertex:qw,logdepthbuf_vertex:Yw,map_fragment:Zw,map_pars_fragment:Kw,map_particle_fragment:Qw,map_particle_pars_fragment:$w,metalnessmap_fragment:Jw,metalnessmap_pars_fragment:eR,morphinstance_vertex:tR,morphcolor_vertex:nR,morphnormal_vertex:iR,morphtarget_pars_vertex:aR,morphtarget_vertex:rR,normal_fragment_begin:sR,normal_fragment_maps:oR,normal_pars_fragment:lR,normal_pars_vertex:cR,normal_vertex:uR,normalmap_pars_fragment:fR,clearcoat_normal_fragment_begin:dR,clearcoat_normal_fragment_maps:hR,clearcoat_pars_fragment:pR,iridescence_pars_fragment:mR,opaque_fragment:gR,packing:vR,premultiplied_alpha_fragment:_R,project_vertex:xR,dithering_fragment:yR,dithering_pars_fragment:SR,roughnessmap_fragment:MR,roughnessmap_pars_fragment:ER,shadowmap_pars_fragment:bR,shadowmap_pars_vertex:TR,shadowmap_vertex:AR,shadowmask_pars_fragment:wR,skinbase_vertex:RR,skinning_pars_vertex:CR,skinning_vertex:NR,skinnormal_vertex:DR,specularmap_fragment:UR,specularmap_pars_fragment:LR,tonemapping_fragment:OR,tonemapping_pars_fragment:PR,transmission_fragment:zR,transmission_pars_fragment:BR,uv_pars_fragment:IR,uv_pars_vertex:FR,uv_vertex:HR,worldpos_vertex:GR,background_vert:VR,background_frag:kR,backgroundCube_vert:jR,backgroundCube_frag:XR,cube_vert:WR,cube_frag:qR,depth_vert:YR,depth_frag:ZR,distanceRGBA_vert:KR,distanceRGBA_frag:QR,equirect_vert:$R,equirect_frag:JR,linedashed_vert:e2,linedashed_frag:t2,meshbasic_vert:n2,meshbasic_frag:i2,meshlambert_vert:a2,meshlambert_frag:r2,meshmatcap_vert:s2,meshmatcap_frag:o2,meshnormal_vert:l2,meshnormal_frag:c2,meshphong_vert:u2,meshphong_frag:f2,meshphysical_vert:d2,meshphysical_frag:h2,meshtoon_vert:p2,meshtoon_frag:m2,points_vert:g2,points_frag:v2,shadow_vert:_2,shadow_frag:x2,sprite_vert:y2,sprite_frag:S2},ue={common:{diffuse:{value:new $e(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new Ie},alphaMap:{value:null},alphaMapTransform:{value:new Ie},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new Ie}},envmap:{envMap:{value:null},envMapRotation:{value:new Ie},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new Ie}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new Ie}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new Ie},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new Ie},normalScale:{value:new at(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new Ie},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new Ie}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new Ie}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new Ie}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new $e(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new $e(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new Ie},alphaTest:{value:0},uvTransform:{value:new Ie}},sprite:{diffuse:{value:new $e(16777215)},opacity:{value:1},center:{value:new at(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new Ie},alphaMap:{value:null},alphaMapTransform:{value:new Ie},alphaTest:{value:0}}},si={basic:{uniforms:sn([ue.common,ue.specularmap,ue.envmap,ue.aomap,ue.lightmap,ue.fog]),vertexShader:He.meshbasic_vert,fragmentShader:He.meshbasic_frag},lambert:{uniforms:sn([ue.common,ue.specularmap,ue.envmap,ue.aomap,ue.lightmap,ue.emissivemap,ue.bumpmap,ue.normalmap,ue.displacementmap,ue.fog,ue.lights,{emissive:{value:new $e(0)}}]),vertexShader:He.meshlambert_vert,fragmentShader:He.meshlambert_frag},phong:{uniforms:sn([ue.common,ue.specularmap,ue.envmap,ue.aomap,ue.lightmap,ue.emissivemap,ue.bumpmap,ue.normalmap,ue.displacementmap,ue.fog,ue.lights,{emissive:{value:new $e(0)},specular:{value:new $e(1118481)},shininess:{value:30}}]),vertexShader:He.meshphong_vert,fragmentShader:He.meshphong_frag},standard:{uniforms:sn([ue.common,ue.envmap,ue.aomap,ue.lightmap,ue.emissivemap,ue.bumpmap,ue.normalmap,ue.displacementmap,ue.roughnessmap,ue.metalnessmap,ue.fog,ue.lights,{emissive:{value:new $e(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:He.meshphysical_vert,fragmentShader:He.meshphysical_frag},toon:{uniforms:sn([ue.common,ue.aomap,ue.lightmap,ue.emissivemap,ue.bumpmap,ue.normalmap,ue.displacementmap,ue.gradientmap,ue.fog,ue.lights,{emissive:{value:new $e(0)}}]),vertexShader:He.meshtoon_vert,fragmentShader:He.meshtoon_frag},matcap:{uniforms:sn([ue.common,ue.bumpmap,ue.normalmap,ue.displacementmap,ue.fog,{matcap:{value:null}}]),vertexShader:He.meshmatcap_vert,fragmentShader:He.meshmatcap_frag},points:{uniforms:sn([ue.points,ue.fog]),vertexShader:He.points_vert,fragmentShader:He.points_frag},dashed:{uniforms:sn([ue.common,ue.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:He.linedashed_vert,fragmentShader:He.linedashed_frag},depth:{uniforms:sn([ue.common,ue.displacementmap]),vertexShader:He.depth_vert,fragmentShader:He.depth_frag},normal:{uniforms:sn([ue.common,ue.bumpmap,ue.normalmap,ue.displacementmap,{opacity:{value:1}}]),vertexShader:He.meshnormal_vert,fragmentShader:He.meshnormal_frag},sprite:{uniforms:sn([ue.sprite,ue.fog]),vertexShader:He.sprite_vert,fragmentShader:He.sprite_frag},background:{uniforms:{uvTransform:{value:new Ie},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:He.background_vert,fragmentShader:He.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new Ie}},vertexShader:He.backgroundCube_vert,fragmentShader:He.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:He.cube_vert,fragmentShader:He.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:He.equirect_vert,fragmentShader:He.equirect_frag},distanceRGBA:{uniforms:sn([ue.common,ue.displacementmap,{referencePosition:{value:new j},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:He.distanceRGBA_vert,fragmentShader:He.distanceRGBA_frag},shadow:{uniforms:sn([ue.lights,ue.fog,{color:{value:new $e(0)},opacity:{value:1}}]),vertexShader:He.shadow_vert,fragmentShader:He.shadow_frag}};si.physical={uniforms:sn([si.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new Ie},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new Ie},clearcoatNormalScale:{value:new at(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new Ie},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new Ie},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new Ie},sheen:{value:0},sheenColor:{value:new $e(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new Ie},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new Ie},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new Ie},transmissionSamplerSize:{value:new at},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new Ie},attenuationDistance:{value:0},attenuationColor:{value:new $e(0)},specularColor:{value:new $e(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new Ie},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new Ie},anisotropyVector:{value:new at},anisotropyMap:{value:null},anisotropyMapTransform:{value:new Ie}}]),vertexShader:He.meshphysical_vert,fragmentShader:He.meshphysical_frag};const kl={r:0,b:0,g:0},Ga=new gi,M2=new Ut;function E2(t,e,n,i,a,r,s){const o=new $e(0);let l=r===!0?0:1,c,d,h=null,f=0,p=null;function x(_){let y=_.isScene===!0?_.background:null;return y&&y.isTexture&&(y=(_.backgroundBlurriness>0?n:e).get(y)),y}function S(_){let y=!1;const R=x(_);R===null?u(o,l):R&&R.isColor&&(u(R,1),y=!0);const A=t.xr.getEnvironmentBlendMode();A==="additive"?i.buffers.color.setClear(0,0,0,1,s):A==="alpha-blend"&&i.buffers.color.setClear(0,0,0,0,s),(t.autoClear||y)&&(i.buffers.depth.setTest(!0),i.buffers.depth.setMask(!0),i.buffers.color.setMask(!0),t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil))}function m(_,y){const R=x(y);R&&(R.isCubeTexture||R.mapping===vu)?(d===void 0&&(d=new ti(new rl(1,1,1),new Da({name:"BackgroundCubeMaterial",uniforms:Ms(si.backgroundCube.uniforms),vertexShader:si.backgroundCube.vertexShader,fragmentShader:si.backgroundCube.fragmentShader,side:gn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),d.geometry.deleteAttribute("normal"),d.geometry.deleteAttribute("uv"),d.onBeforeRender=function(A,w,N){this.matrixWorld.copyPosition(N.matrixWorld)},Object.defineProperty(d.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),a.update(d)),Ga.copy(y.backgroundRotation),Ga.x*=-1,Ga.y*=-1,Ga.z*=-1,R.isCubeTexture&&R.isRenderTargetTexture===!1&&(Ga.y*=-1,Ga.z*=-1),d.material.uniforms.envMap.value=R,d.material.uniforms.flipEnvMap.value=R.isCubeTexture&&R.isRenderTargetTexture===!1?-1:1,d.material.uniforms.backgroundBlurriness.value=y.backgroundBlurriness,d.material.uniforms.backgroundIntensity.value=y.backgroundIntensity,d.material.uniforms.backgroundRotation.value.setFromMatrix4(M2.makeRotationFromEuler(Ga)),d.material.toneMapped=tt.getTransfer(R.colorSpace)!==ut,(h!==R||f!==R.version||p!==t.toneMapping)&&(d.material.needsUpdate=!0,h=R,f=R.version,p=t.toneMapping),d.layers.enableAll(),_.unshift(d,d.geometry,d.material,0,0,null)):R&&R.isTexture&&(c===void 0&&(c=new ti(new _u(2,2),new Da({name:"BackgroundMaterial",uniforms:Ms(si.background.uniforms),vertexShader:si.background.vertexShader,fragmentShader:si.background.fragmentShader,side:Na,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute("normal"),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),a.update(c)),c.material.uniforms.t2D.value=R,c.material.uniforms.backgroundIntensity.value=y.backgroundIntensity,c.material.toneMapped=tt.getTransfer(R.colorSpace)!==ut,R.matrixAutoUpdate===!0&&R.updateMatrix(),c.material.uniforms.uvTransform.value.copy(R.matrix),(h!==R||f!==R.version||p!==t.toneMapping)&&(c.material.needsUpdate=!0,h=R,f=R.version,p=t.toneMapping),c.layers.enableAll(),_.unshift(c,c.geometry,c.material,0,0,null))}function u(_,y){_.getRGB(kl,dy(t)),i.buffers.color.setClear(kl.r,kl.g,kl.b,y,s)}function g(){d!==void 0&&(d.geometry.dispose(),d.material.dispose(),d=void 0),c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0)}return{getClearColor:function(){return o},setClearColor:function(_,y=1){o.set(_),l=y,u(o,l)},getClearAlpha:function(){return l},setClearAlpha:function(_){l=_,u(o,l)},render:S,addToRenderList:m,dispose:g}}function b2(t,e){const n=t.getParameter(t.MAX_VERTEX_ATTRIBS),i={},a=f(null);let r=a,s=!1;function o(E,L,z,B,I){let Q=!1;const O=h(B,z,L);r!==O&&(r=O,c(r.object)),Q=p(E,B,z,I),Q&&x(E,B,z,I),I!==null&&e.update(I,t.ELEMENT_ARRAY_BUFFER),(Q||s)&&(s=!1,y(E,L,z,B),I!==null&&t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,e.get(I).buffer))}function l(){return t.createVertexArray()}function c(E){return t.bindVertexArray(E)}function d(E){return t.deleteVertexArray(E)}function h(E,L,z){const B=z.wireframe===!0;let I=i[E.id];I===void 0&&(I={},i[E.id]=I);let Q=I[L.id];Q===void 0&&(Q={},I[L.id]=Q);let O=Q[B];return O===void 0&&(O=f(l()),Q[B]=O),O}function f(E){const L=[],z=[],B=[];for(let I=0;I<n;I++)L[I]=0,z[I]=0,B[I]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:L,enabledAttributes:z,attributeDivisors:B,object:E,attributes:{},index:null}}function p(E,L,z,B){const I=r.attributes,Q=L.attributes;let O=0;const V=z.getAttributes();for(const D in V)if(V[D].location>=0){const Z=I[D];let ae=Q[D];if(ae===void 0&&(D==="instanceMatrix"&&E.instanceMatrix&&(ae=E.instanceMatrix),D==="instanceColor"&&E.instanceColor&&(ae=E.instanceColor)),Z===void 0||Z.attribute!==ae||ae&&Z.data!==ae.data)return!0;O++}return r.attributesNum!==O||r.index!==B}function x(E,L,z,B){const I={},Q=L.attributes;let O=0;const V=z.getAttributes();for(const D in V)if(V[D].location>=0){let Z=Q[D];Z===void 0&&(D==="instanceMatrix"&&E.instanceMatrix&&(Z=E.instanceMatrix),D==="instanceColor"&&E.instanceColor&&(Z=E.instanceColor));const ae={};ae.attribute=Z,Z&&Z.data&&(ae.data=Z.data),I[D]=ae,O++}r.attributes=I,r.attributesNum=O,r.index=B}function S(){const E=r.newAttributes;for(let L=0,z=E.length;L<z;L++)E[L]=0}function m(E){u(E,0)}function u(E,L){const z=r.newAttributes,B=r.enabledAttributes,I=r.attributeDivisors;z[E]=1,B[E]===0&&(t.enableVertexAttribArray(E),B[E]=1),I[E]!==L&&(t.vertexAttribDivisor(E,L),I[E]=L)}function g(){const E=r.newAttributes,L=r.enabledAttributes;for(let z=0,B=L.length;z<B;z++)L[z]!==E[z]&&(t.disableVertexAttribArray(z),L[z]=0)}function _(E,L,z,B,I,Q,O){O===!0?t.vertexAttribIPointer(E,L,z,I,Q):t.vertexAttribPointer(E,L,z,B,I,Q)}function y(E,L,z,B){S();const I=B.attributes,Q=z.getAttributes(),O=L.defaultAttributeValues;for(const V in Q){const D=Q[V];if(D.location>=0){let q=I[V];if(q===void 0&&(V==="instanceMatrix"&&E.instanceMatrix&&(q=E.instanceMatrix),V==="instanceColor"&&E.instanceColor&&(q=E.instanceColor)),q!==void 0){const Z=q.normalized,ae=q.itemSize,Re=e.get(q);if(Re===void 0)continue;const Ve=Re.buffer,Y=Re.type,J=Re.bytesPerElement,pe=Y===t.INT||Y===t.UNSIGNED_INT||q.gpuType===Pp;if(q.isInterleavedBufferAttribute){const le=q.data,ye=le.stride,Me=q.offset;if(le.isInstancedInterleavedBuffer){for(let be=0;be<D.locationSize;be++)u(D.location+be,le.meshPerAttribute);E.isInstancedMesh!==!0&&B._maxInstanceCount===void 0&&(B._maxInstanceCount=le.meshPerAttribute*le.count)}else for(let be=0;be<D.locationSize;be++)m(D.location+be);t.bindBuffer(t.ARRAY_BUFFER,Ve);for(let be=0;be<D.locationSize;be++)_(D.location+be,ae/D.locationSize,Y,Z,ye*J,(Me+ae/D.locationSize*be)*J,pe)}else{if(q.isInstancedBufferAttribute){for(let le=0;le<D.locationSize;le++)u(D.location+le,q.meshPerAttribute);E.isInstancedMesh!==!0&&B._maxInstanceCount===void 0&&(B._maxInstanceCount=q.meshPerAttribute*q.count)}else for(let le=0;le<D.locationSize;le++)m(D.location+le);t.bindBuffer(t.ARRAY_BUFFER,Ve);for(let le=0;le<D.locationSize;le++)_(D.location+le,ae/D.locationSize,Y,Z,ae*J,ae/D.locationSize*le*J,pe)}}else if(O!==void 0){const Z=O[V];if(Z!==void 0)switch(Z.length){case 2:t.vertexAttrib2fv(D.location,Z);break;case 3:t.vertexAttrib3fv(D.location,Z);break;case 4:t.vertexAttrib4fv(D.location,Z);break;default:t.vertexAttrib1fv(D.location,Z)}}}}g()}function R(){N();for(const E in i){const L=i[E];for(const z in L){const B=L[z];for(const I in B)d(B[I].object),delete B[I];delete L[z]}delete i[E]}}function A(E){if(i[E.id]===void 0)return;const L=i[E.id];for(const z in L){const B=L[z];for(const I in B)d(B[I].object),delete B[I];delete L[z]}delete i[E.id]}function w(E){for(const L in i){const z=i[L];if(z[E.id]===void 0)continue;const B=z[E.id];for(const I in B)d(B[I].object),delete B[I];delete z[E.id]}}function N(){T(),s=!0,r!==a&&(r=a,c(r.object))}function T(){a.geometry=null,a.program=null,a.wireframe=!1}return{setup:o,reset:N,resetDefaultState:T,dispose:R,releaseStatesOfGeometry:A,releaseStatesOfProgram:w,initAttributes:S,enableAttribute:m,disableUnusedAttributes:g}}function T2(t,e,n){let i;function a(c){i=c}function r(c,d){t.drawArrays(i,c,d),n.update(d,i,1)}function s(c,d,h){h!==0&&(t.drawArraysInstanced(i,c,d,h),n.update(d,i,h))}function o(c,d,h){if(h===0)return;e.get("WEBGL_multi_draw").multiDrawArraysWEBGL(i,c,0,d,0,h);let p=0;for(let x=0;x<h;x++)p+=d[x];n.update(p,i,1)}function l(c,d,h,f){if(h===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let x=0;x<c.length;x++)s(c[x],d[x],f[x]);else{p.multiDrawArraysInstancedWEBGL(i,c,0,d,0,f,0,h);let x=0;for(let S=0;S<h;S++)x+=d[S]*f[S];n.update(x,i,1)}}this.setMode=a,this.render=r,this.renderInstances=s,this.renderMultiDraw=o,this.renderMultiDrawInstances=l}function A2(t,e,n,i){let a;function r(){if(a!==void 0)return a;if(e.has("EXT_texture_filter_anisotropic")===!0){const w=e.get("EXT_texture_filter_anisotropic");a=t.getParameter(w.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else a=0;return a}function s(w){return!(w!==ei&&i.convert(w)!==t.getParameter(t.IMPLEMENTATION_COLOR_READ_FORMAT))}function o(w){const N=w===el&&(e.has("EXT_color_buffer_half_float")||e.has("EXT_color_buffer_float"));return!(w!==mi&&i.convert(w)!==t.getParameter(t.IMPLEMENTATION_COLOR_READ_TYPE)&&w!==zi&&!N)}function l(w){if(w==="highp"){if(t.getShaderPrecisionFormat(t.VERTEX_SHADER,t.HIGH_FLOAT).precision>0&&t.getShaderPrecisionFormat(t.FRAGMENT_SHADER,t.HIGH_FLOAT).precision>0)return"highp";w="mediump"}return w==="mediump"&&t.getShaderPrecisionFormat(t.VERTEX_SHADER,t.MEDIUM_FLOAT).precision>0&&t.getShaderPrecisionFormat(t.FRAGMENT_SHADER,t.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let c=n.precision!==void 0?n.precision:"highp";const d=l(c);d!==c&&(console.warn("THREE.WebGLRenderer:",c,"not supported, using",d,"instead."),c=d);const h=n.logarithmicDepthBuffer===!0,f=n.reverseDepthBuffer===!0&&e.has("EXT_clip_control"),p=t.getParameter(t.MAX_TEXTURE_IMAGE_UNITS),x=t.getParameter(t.MAX_VERTEX_TEXTURE_IMAGE_UNITS),S=t.getParameter(t.MAX_TEXTURE_SIZE),m=t.getParameter(t.MAX_CUBE_MAP_TEXTURE_SIZE),u=t.getParameter(t.MAX_VERTEX_ATTRIBS),g=t.getParameter(t.MAX_VERTEX_UNIFORM_VECTORS),_=t.getParameter(t.MAX_VARYING_VECTORS),y=t.getParameter(t.MAX_FRAGMENT_UNIFORM_VECTORS),R=x>0,A=t.getParameter(t.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:r,getMaxPrecision:l,textureFormatReadable:s,textureTypeReadable:o,precision:c,logarithmicDepthBuffer:h,reverseDepthBuffer:f,maxTextures:p,maxVertexTextures:x,maxTextureSize:S,maxCubemapSize:m,maxAttributes:u,maxVertexUniforms:g,maxVaryings:_,maxFragmentUniforms:y,vertexTextures:R,maxSamples:A}}function w2(t){const e=this;let n=null,i=0,a=!1,r=!1;const s=new Wa,o=new Ie,l={value:null,needsUpdate:!1};this.uniform=l,this.numPlanes=0,this.numIntersection=0,this.init=function(h,f){const p=h.length!==0||f||i!==0||a;return a=f,i=h.length,p},this.beginShadows=function(){r=!0,d(null)},this.endShadows=function(){r=!1},this.setGlobalState=function(h,f){n=d(h,f,0)},this.setState=function(h,f,p){const x=h.clippingPlanes,S=h.clipIntersection,m=h.clipShadows,u=t.get(h);if(!a||x===null||x.length===0||r&&!m)r?d(null):c();else{const g=r?0:i,_=g*4;let y=u.clippingState||null;l.value=y,y=d(x,f,_,p);for(let R=0;R!==_;++R)y[R]=n[R];u.clippingState=y,this.numIntersection=S?this.numPlanes:0,this.numPlanes+=g}};function c(){l.value!==n&&(l.value=n,l.needsUpdate=i>0),e.numPlanes=i,e.numIntersection=0}function d(h,f,p,x){const S=h!==null?h.length:0;let m=null;if(S!==0){if(m=l.value,x!==!0||m===null){const u=p+S*4,g=f.matrixWorldInverse;o.getNormalMatrix(g),(m===null||m.length<u)&&(m=new Float32Array(u));for(let _=0,y=p;_!==S;++_,y+=4)s.copy(h[_]).applyMatrix4(g,o),s.normal.toArray(m,y),m[y+3]=s.constant}l.value=m,l.needsUpdate=!0}return e.numPlanes=S,e.numIntersection=0,m}}function R2(t){let e=new WeakMap;function n(s,o){return o===qd?s.mapping=xs:o===Yd&&(s.mapping=ys),s}function i(s){if(s&&s.isTexture){const o=s.mapping;if(o===qd||o===Yd)if(e.has(s)){const l=e.get(s).texture;return n(l,s.mapping)}else{const l=s.image;if(l&&l.height>0){const c=new DA(l.height);return c.fromEquirectangularTexture(t,s),e.set(s,c),s.addEventListener("dispose",a),n(c.texture,s.mapping)}else return null}}return s}function a(s){const o=s.target;o.removeEventListener("dispose",a);const l=e.get(o);l!==void 0&&(e.delete(o),l.dispose())}function r(){e=new WeakMap}return{get:i,dispose:r}}const Zr=4,r0=[.125,.215,.35,.446,.526,.582],Za=20,Uf=new xy,s0=new $e;let Lf=null,Of=0,Pf=0,zf=!1;const qa=(1+Math.sqrt(5))/2,Ur=1/qa,o0=[new j(-qa,Ur,0),new j(qa,Ur,0),new j(-Ur,0,qa),new j(Ur,0,qa),new j(0,qa,-Ur),new j(0,qa,Ur),new j(-1,1,-1),new j(1,1,-1),new j(-1,1,1),new j(1,1,1)],C2=new j;class l0{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(e,n=0,i=.1,a=100,r={}){const{size:s=256,position:o=C2}=r;Lf=this._renderer.getRenderTarget(),Of=this._renderer.getActiveCubeFace(),Pf=this._renderer.getActiveMipmapLevel(),zf=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(s);const l=this._allocateTargets();return l.depthBuffer=!0,this._sceneToCubeUV(e,i,a,l,o),n>0&&this._blur(l,0,0,n),this._applyPMREM(l),this._cleanup(l),l}fromEquirectangular(e,n=null){return this._fromTexture(e,n)}fromCubemap(e,n=null){return this._fromTexture(e,n)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=f0(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=u0(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodPlanes.length;e++)this._lodPlanes[e].dispose()}_cleanup(e){this._renderer.setRenderTarget(Lf,Of,Pf),this._renderer.xr.enabled=zf,e.scissorTest=!1,jl(e,0,0,e.width,e.height)}_fromTexture(e,n){e.mapping===xs||e.mapping===ys?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),Lf=this._renderer.getRenderTarget(),Of=this._renderer.getActiveCubeFace(),Pf=this._renderer.getActiveMipmapLevel(),zf=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const i=n||this._allocateTargets();return this._textureToCubeUV(e,i),this._applyPMREM(i),this._cleanup(i),i}_allocateTargets(){const e=3*Math.max(this._cubeSize,112),n=4*this._cubeSize,i={magFilter:ci,minFilter:ci,generateMipmaps:!1,type:el,format:ei,colorSpace:Ss,depthBuffer:!1},a=c0(e,n,i);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==n){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=c0(e,n,i);const{_lodMax:r}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=N2(r)),this._blurMaterial=D2(r,e,n)}return a}_compileMaterial(e){const n=new ti(this._lodPlanes[0],e);this._renderer.compile(n,Uf)}_sceneToCubeUV(e,n,i,a,r){const l=new wn(90,1,n,i),c=[1,-1,1,1,1,1],d=[1,1,1,-1,-1,-1],h=this._renderer,f=h.autoClear,p=h.toneMapping;h.getClearColor(s0),h.toneMapping=Aa,h.autoClear=!1;const x=new cy({name:"PMREM.Background",side:gn,depthWrite:!1,depthTest:!1}),S=new ti(new rl,x);let m=!1;const u=e.background;u?u.isColor&&(x.color.copy(u),e.background=null,m=!0):(x.color.copy(s0),m=!0);for(let g=0;g<6;g++){const _=g%3;_===0?(l.up.set(0,c[g],0),l.position.set(r.x,r.y,r.z),l.lookAt(r.x+d[g],r.y,r.z)):_===1?(l.up.set(0,0,c[g]),l.position.set(r.x,r.y,r.z),l.lookAt(r.x,r.y+d[g],r.z)):(l.up.set(0,c[g],0),l.position.set(r.x,r.y,r.z),l.lookAt(r.x,r.y,r.z+d[g]));const y=this._cubeSize;jl(a,_*y,g>2?y:0,y,y),h.setRenderTarget(a),m&&h.render(S,l),h.render(e,l)}S.geometry.dispose(),S.material.dispose(),h.toneMapping=p,h.autoClear=f,e.background=u}_textureToCubeUV(e,n){const i=this._renderer,a=e.mapping===xs||e.mapping===ys;a?(this._cubemapMaterial===null&&(this._cubemapMaterial=f0()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=u0());const r=a?this._cubemapMaterial:this._equirectMaterial,s=new ti(this._lodPlanes[0],r),o=r.uniforms;o.envMap.value=e;const l=this._cubeSize;jl(n,0,0,3*l,2*l),i.setRenderTarget(n),i.render(s,Uf)}_applyPMREM(e){const n=this._renderer,i=n.autoClear;n.autoClear=!1;const a=this._lodPlanes.length;for(let r=1;r<a;r++){const s=Math.sqrt(this._sigmas[r]*this._sigmas[r]-this._sigmas[r-1]*this._sigmas[r-1]),o=o0[(a-r-1)%o0.length];this._blur(e,r-1,r,s,o)}n.autoClear=i}_blur(e,n,i,a,r){const s=this._pingPongRenderTarget;this._halfBlur(e,s,n,i,a,"latitudinal",r),this._halfBlur(s,e,i,i,a,"longitudinal",r)}_halfBlur(e,n,i,a,r,s,o){const l=this._renderer,c=this._blurMaterial;s!=="latitudinal"&&s!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const d=3,h=new ti(this._lodPlanes[a],c),f=c.uniforms,p=this._sizeLods[i]-1,x=isFinite(r)?Math.PI/(2*p):2*Math.PI/(2*Za-1),S=r/x,m=isFinite(r)?1+Math.floor(d*S):Za;m>Za&&console.warn(`sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Za}`);const u=[];let g=0;for(let w=0;w<Za;++w){const N=w/S,T=Math.exp(-N*N/2);u.push(T),w===0?g+=T:w<m&&(g+=2*T)}for(let w=0;w<u.length;w++)u[w]=u[w]/g;f.envMap.value=e.texture,f.samples.value=m,f.weights.value=u,f.latitudinal.value=s==="latitudinal",o&&(f.poleAxis.value=o);const{_lodMax:_}=this;f.dTheta.value=x,f.mipInt.value=_-i;const y=this._sizeLods[a],R=3*y*(a>_-Zr?a-_+Zr:0),A=4*(this._cubeSize-y);jl(n,R,A,3*y,2*y),l.setRenderTarget(n),l.render(h,Uf)}}function N2(t){const e=[],n=[],i=[];let a=t;const r=t-Zr+1+r0.length;for(let s=0;s<r;s++){const o=Math.pow(2,a);n.push(o);let l=1/o;s>t-Zr?l=r0[s-t+Zr-1]:s===0&&(l=0),i.push(l);const c=1/(o-2),d=-c,h=1+c,f=[d,d,h,d,h,h,d,d,h,h,d,h],p=6,x=6,S=3,m=2,u=1,g=new Float32Array(S*x*p),_=new Float32Array(m*x*p),y=new Float32Array(u*x*p);for(let A=0;A<p;A++){const w=A%3*2/3-1,N=A>2?0:-1,T=[w,N,0,w+2/3,N,0,w+2/3,N+1,0,w,N,0,w+2/3,N+1,0,w,N+1,0];g.set(T,S*x*A),_.set(f,m*x*A);const E=[A,A,A,A,A,A];y.set(E,u*x*A)}const R=new Ki;R.setAttribute("position",new hi(g,S)),R.setAttribute("uv",new hi(_,m)),R.setAttribute("faceIndex",new hi(y,u)),e.push(R),a>Zr&&a--}return{lodPlanes:e,sizeLods:n,sigmas:i}}function c0(t,e,n){const i=new ur(t,e,n);return i.texture.mapping=vu,i.texture.name="PMREM.cubeUv",i.scissorTest=!0,i}function jl(t,e,n,i,a){t.viewport.set(e,n,i,a),t.scissor.set(e,n,i,a)}function D2(t,e,n){const i=new Float32Array(Za),a=new j(0,1,0);return new Da({name:"SphericalGaussianBlur",defines:{n:Za,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:a}},vertexShader:jp(),fragmentShader:`
...
`)+`
`+u);const _=g+m+s,y=g+u+o,R=x0(a,a.VERTEX_SHADER,_),A=x0(a,a.FRAGMENT_SHADER,y);a.attachShader(S,R),a.attachShader(S,A),n.index0AttributeName!==void 0?a.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(S,0,"position"),a.linkProgram(S);function w(L){if(t.debug.checkShaderErrors){const z=a.getProgramInfoLog(S).trim(),B=a.getShaderInfoLog(R).trim(),I=a.getShaderInfoLog(A).trim();let Q=!0,O=!0;if(a.getProgramParameter(S,a.LINK_STATUS)===!1)if(Q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(a,S,R,A);else{const V=S0(a,R,"vertex"),D=S0(a,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(S,a.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+V+`
`+D)}else z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",z):(B===""||I==="")&&(O=!1);O&&(L.diagnostics={runnable:Q,programLog:z,vertexShader:{log:B,prefix:m},fragmentShader:{log:I,prefix:u}})}a.deleteShader(R),a.deleteShader(A),N=new dc(a,S),T=IC(a,S)}let N;this.getUniforms=function(){return N===void 0&&w(this),N};let T;this.getAttributes=function(){return T===void 0&&w(this),T};let E=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return E===!1&&(E=a.getProgramParameter(S,CC)),E},this.destroy=function(){i.releaseStatesOfProgram(this),a.deleteProgram(S),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=NC++,this.cacheKey=e,this.usedTimes=1,this.program=S,this.vertexShader=R,this.fragmentShader=A,this}let KC=0;class QC{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,a=this._getShaderStage(n),r=this._getShaderStage(i),s=this._getShaderCacheForMaterial(e);return s.has(a)===!1&&(s.add(a),a.usedTimes++),s.has(r)===!1&&(s.add(r),r.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new $C(e),n.set(e,i)),i}}class $C{constructor(e){this.id=KC++,this.code=e,this.usedTimes=0}}function JC(t,e,n,i,a,r,s){const o=new oy,l=new QC,c=new Set,d=[],h=a.logarithmicDepthBuffer,f=a.vertexTextures;let p=a.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function S(T){return c.add(T),T===0?"uv":`uv${T}`}function m(T,E,L,z,B){const I=z.fog,Q=B.geometry,O=T.isMeshStandardMaterial?z.environment:null,V=(T.isMeshStandardMaterial?n:e).get(T.envMap||O),D=V&&V.mapping===vu?V.image.height:null,q=x[T.type];T.precision!==null&&(p=a.getMaxPrecision(T.precision),p!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",p,"instead."));const Z=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,ae=Z!==void 0?Z.length:0;let Re=0;Q.morphAttributes.position!==void 0&&(Re=1),Q.morphAttributes.normal!==void 0&&(Re=2),Q.morphAttributes.color!==void 0&&(Re=3);let Ve,Y,J,pe;if(q){const st=si[q];Ve=st.vertexShader,Y=st.fragmentShader}else Ve=T.vertexShader,Y=T.fragmentShader,l.update(T),J=l.getVertexShaderID(T),pe=l.getFragmentShaderID(T);const le=t.getRenderTarget(),ye=t.state.buffers.depth.getReversed(),Me=B.isInstancedMesh===!0,be=B.isBatchedMesh===!0,We=!!T.map,vt=!!T.matcap,Ke=!!V,U=!!T.aoMap,jt=!!T.lightMap,Qe=!!T.bumpMap,mt=!!T.normalMap,Ee=!!T.displacementMap,Je=!!T.emissiveMap,Ce=!!T.metalnessMap,Fe=!!T.roughnessMap,It=T.anisotropy>0,C=T.clearcoat>0,M=T.dispersion>0,k=T.iridescence>0,$=T.sheen>0,ne=T.transmission>0,K=It&&!!T.anisotropyMap,Te=C&&!!T.clearcoatMap,fe=C&&!!T.clearcoatNormalMap,Se=C&&!!T.clearcoatRoughnessMap,Ae=k&&!!T.iridescenceMap,ie=k&&!!T.iridescenceThicknessMap,me=$&&!!T.sheenColorMap,Ue=$&&!!T.sheenRoughnessMap,De=!!T.specularMap,ce=!!T.specularColorMap,ze=!!T.specularIntensityMap,P=ne&&!!T.transmissionMap,de=ne&&!!T.thicknessMap,re=!!T.gradientMap,ve=!!T.alphaMap,se=T.alphaTest>0,te=!!T.alphaHash,_e=!!T.extensions;let Be=Aa;T.toneMapped&&(le===null||le.isXRRenderTarget===!0)&&(Be=t.toneMapping);const _t={shaderID:q,shaderType:T.type,shaderName:T.name,vertexShader:Ve,fragmentShader:Y,defines:T.defines,customVertexShaderID:J,customFragmentShaderID:pe,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:p,batching:be,batchingColor:be&&B._colorsTexture!==null,instancing:Me,instancingColor:Me&&B.instanceColor!==null,instancingMorph:Me&&B.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:le===null?t.outputColorSpace:le.isXRRenderTarget===!0?le.texture.colorSpace:Ss,alphaToCoverage:!!T.alphaToCoverage,map:We,matcap:vt,envMap:Ke,envMapMode:Ke&&V.mapping,envMapCubeUVHeight:D,aoMap:U,lightMap:jt,bumpMap:Qe,normalMap:mt,displacementMap:f&&Ee,emissiveMap:Je,normalMapObjectSpace:mt&&T.normalMapType===ZT,normalMapTangentSpace:mt&&T.normalMapType===iy,metalnessMap:Ce,roughnessMap:Fe,anisotropy:It,anisotropyMap:K,clearcoat:C,clearcoatMap:Te,clearcoatNormalMap:fe,clearcoatRoughnessMap:Se,dispersion:M,iridescence:k,iridescenceMap:Ae,iridescenceThicknessMap:ie,sheen:$,sheenColorMap:me,sheenRoughnessMap:Ue,specularMap:De,specularColorMap:ce,specularIntensityMap:ze,transmission:ne,transmissionMap:P,thicknessMap:de,gradientMap:re,opaque:T.transparent===!1&&T.blending===as&&T.alphaToCoverage===!1,alphaMap:ve,alphaTest:se,alphaHash:te,combine:T.combine,mapUv:We&&S(T.map.channel),aoMapUv:U&&S(T.aoMap.channel),lightMapUv:jt&&S(T.lightMap.channel),bumpMapUv:Qe&&S(T.bumpMap.channel),normalMapUv:mt&&S(T.normalMap.channel),displacementMapUv:Ee&&S(T.displacementMap.channel),emissiveMapUv:Je&&S(T.emissiveMap.channel),metalnessMapUv:Ce&&S(T.metalnessMap.channel),roughnessMapUv:Fe&&S(T.roughnessMap.channel),anisotropyMapUv:K&&S(T.anisotropyMap.channel),clearcoatMapUv:Te&&S(T.clearcoatMap.channel),clearcoatNormalMapUv:fe&&S(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Se&&S(T.clearcoatRoughnessMap.channel),iridescenceMapUv:Ae&&S(T.iridescenceMap.channel),iridescenceThicknessMapUv:ie&&S(T.iridescenceThicknessMap.channel),sheenColorMapUv:me&&S(T.sheenColorMap.channel),sheenRoughnessMapUv:Ue&&S(T.sheenRoughnessMap.channel),specularMapUv:De&&S(T.specularMap.channel),specularColorMapUv:ce&&S(T.specularColorMap.channel),specularIntensityMapUv:ze&&S(T.specularIntensityMap.channel),transmissionMapUv:P&&S(T.transmissionMap.channel),thicknessMapUv:de&&S(T.thicknessMap.channel),alphaMapUv:ve&&S(T.alphaMap.channel),vertexTangents:!!Q.attributes.tangent&&(mt||It),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!Q.attributes.uv&&(We||ve),fog:!!I,useFog:T.fog===!0,fogExp2:!!I&&I.isFogExp2,flatShading:T.flatShading===!0&&T.wireframe===!1,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:h,reverseDepthBuffer:ye,skinning:B.isSkinnedMesh===!0,morphTargets:Q.morphAttributes.position!==void 0,morphNormals:Q.morphAttributes.normal!==void 0,morphColors:Q.morphAttributes.color!==void 0,morphTargetsCount:ae,morphTextureStride:Re,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:T.dithering,shadowMapEnabled:t.shadowMap.enabled&&L.length>0,shadowMapType:t.shadowMap.type,toneMapping:Be,decodeVideoTexture:We&&T.map.isVideoTexture===!0&&tt.getTransfer(T.map.colorSpace)===ut,decodeVideoTextureEmissive:Je&&T.emissiveMap.isVideoTexture===!0&&tt.getTransfer(T.emissiveMap.colorSpace)===ut,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===$n,flipSided:T.side===gn,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:_e&&T.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&T.extensions.multiDraw===!0||be)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return _t.vertexUv1s=c.has(1),_t.vertexUv2s=c.has(2),_t.vertexUv3s=c.has(3),c.clear(),_t}function u(T){const E=[];if(T.shaderID?E.push(T.shaderID):(E.push(T.customVertexShaderID),E.push(T.customFragmentShaderID)),T.defines!==void 0)for(const L in T.defines)E.push(L),E.push(T.defines[L]);return T.isRawShaderMaterial===!1&&(g(E,T),_(E,T),E.push(t.outputColorSpace)),E.push(T.customProgramCacheKey),E.join()}function g(T,E){T.push(E.precision),T.push(E.outputColorSpace),T.push(E.envMapMode),T.push(E.envMapCubeUVHeight),T.push(E.mapUv),T.push(E.alphaMapUv),T.push(E.lightMapUv),T.push(E.aoMapUv),T.push(E.bumpMapUv),T.push(E.normalMapUv),T.push(E.displacementMapUv),T.push(E.emissiveMapUv),T.push(E.metalnessMapUv),T.push(E.roughnessMapUv),T.push(E.anisotropyMapUv),T.push(E.clearcoatMapUv),T.push(E.clearcoatNormalMapUv),T.push(E.clearcoatRoughnessMapUv),T.push(E.iridescenceMapUv),T.push(E.iridescenceThicknessMapUv),T.push(E.sheenColorMapUv),T.push(E.sheenRoughnessMapUv),T.push(E.specularMapUv),T.push(E.specularColorMapUv),T.push(E.specularIntensityMapUv),T.push(E.transmissionMapUv),T.push(E.thicknessMapUv),T.push(E.combine),T.push(E.fogExp2),T.push(E.sizeAttenuation),T.push(E.morphTargetsCount),T.push(E.morphAttributeCount),T.push(E.numDirLights),T.push(E.numPointLights),T.push(E.numSpotLights),T.push(E.numSpotLightMaps),T.push(E.numHemiLights),T.push(E.numRectAreaLights),T.push(E.numDirLightShadows),T.push(E.numPointLightShadows),T.push(E.numSpotLightShadows),T.push(E.numSpotLightShadowsWithMaps),T.push(E.numLightProbes),T.push(E.shadowMapType),T.push(E.toneMapping),T.push(E.numClippingPlanes),T.push(E.numClipIntersection),T.push(E.depthPacking)}function _(T,E){o.disableAll(),E.supportsVertexTextures&&o.enable(0),E.instancing&&o.enable(1),E.instancingColor&&o.enable(2),E.instancingMorph&&o.enable(3),E.matcap&&o.enable(4),E.envMap&&o.enable(5),E.normalMapObjectSpace&&o.enable(6),E.normalMapTangentSpace&&o.enable(7),E.clearcoat&&o.enable(8),E.iridescence&&o.enable(9),E.alphaTest&&o.enable(10),E.vertexColors&&o.enable(11),E.vertexAlphas&&o.enable(12),E.vertexUv1s&&o.enable(13),E.vertexUv2s&&o.enable(14),E.vertexUv3s&&o.enable(15),E.vertexTangents&&o.enable(16),E.anisotropy&&o.enable(17),E.alphaHash&&o.enable(18),E.batching&&o.enable(19),E.dispersion&&o.enable(20),E.batchingColor&&o.enable(21),E.gradientMap&&o.enable(22),T.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.reverseDepthBuffer&&o.enable(4),E.skinning&&o.enable(5),E.morphTargets&&o.enable(6),E.morphNormals&&o.enable(7),E.morphColors&&o.enable(8),E.premultipliedAlpha&&o.enable(9),E.shadowMapEnabled&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),E.decodeVideoTexture&&o.enable(19),E.decodeVideoTextureEmissive&&o.enable(20),E.alphaToCoverage&&o.enable(21),T.push(o.mask)}function y(T){const E=x[T.type];let L;if(E){const z=si[E];L=wA.clone(z.uniforms)}else L=T.uniforms;return L}function R(T,E){let L;for(let z=0,B=d.length;z<B;z++){const I=d[z];if(I.cacheKey===E){L=I,++L.usedTimes;break}}return L===void 0&&(L=new ZC(t,E,T,r),d.push(L)),L}function A(T){if(--T.usedTimes===0){const E=d.indexOf(T);d[E]=d[d.length-1],d.pop(),T.destroy()}}function w(T){l.remove(T)}function N(){l.dispose()}return{getParameters:m,getProgramCacheKey:u,getUniforms:y,acquireProgram:R,releaseProgram:A,releaseShaderCache:w,programs:d,dispose:N}}function e3(){let t=new WeakMap;function e(s){return t.has(s)}function n(s){let o=t.get(s);return o===void 0&&(o={},t.set(s,o)),o}function i(s){t.delete(s)}function a(s,o,l){t.get(s)[o]=l}function r(){t=new WeakMap}return{has:e,get:n,remove:i,update:a,dispose:r}}function t3(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function A0(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function w0(){const t=[];let e=0;const n=[],i=[],a=[];function r(){e=0,n.length=0,i.length=0,a.length=0}function s(h,f,p,x,S,m){let u=t[e];return u===void 0?(u={id:h.id,object:h,geometry:f,material:p,groupOrder:x,renderOrder:h.renderOrder,z:S,group:m},t[e]=u):(u.id=h.id,u.object=h,u.geometry=f,u.material=p,u.groupOrder=x,u.renderOrder=h.renderOrder,u.z=S,u.group=m),e++,u}function o(h,f,p,x,S,m){const u=s(h,f,p,x,S,m);p.transmission>0?i.push(u):p.transparent===!0?a.push(u):n.push(u)}function l(h,f,p,x,S,m){const u=s(h,f,p,x,S,m);p.transmission>0?i.unshift(u):p.transparent===!0?a.unshift(u):n.unshift(u)}function c(h,f){n.length>1&&n.sort(h||t3),i.length>1&&i.sort(f||A0),a.length>1&&a.sort(f||A0)}function d(){for(let h=e,f=t.length;h<f;h++){const p=t[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:n,transmissive:i,transparent:a,init:r,push:o,unshift:l,finish:d,sort:c}}function n3(){let t=new WeakMap;function e(i,a){const r=t.get(i);let s;return r===void 0?(s=new w0,t.set(i,[s])):a>=r.length?(s=new w0,r.push(s)):s=r[a],s}function n(){t=new WeakMap}return{get:e,dispose:n}}function i3(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new j,color:new $e};break;case"SpotLight":n={position:new j,direction:new j,color:new $e,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new j,color:new $e,distance:0,decay:0};break;case"HemisphereLight":n={direction:new j,skyColor:new $e,groundColor:new $e};break;case"RectAreaLight":n={color:new $e,position:new j,halfWidth:new j,halfHeight:new j};break}return t[e.id]=n,n}}}function a3(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let r3=0;function s3(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function o3(t){const e=new i3,n=a3(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new j);const a=new j,r=new Ut,s=new Ut;function o(c){let d=0,h=0,f=0;for(let T=0;T<9;T++)i.probe[T].set(0,0,0);let p=0,x=0,S=0,m=0,u=0,g=0,_=0,y=0,R=0,A=0,w=0;c.sort(s3);for(let T=0,E=c.length;T<E;T++){const L=c[T],z=L.color,B=L.intensity,I=L.distance,Q=L.shadow&&L.shadow.map?L.shadow.map.texture:null;if(L.isAmbientLight)d+=z.r*B,h+=z.g*B,f+=z.b*B;else if(L.isLightProbe){for(let O=0;O<9;O++)i.probe[O].addScaledVector(L.sh.coefficients[O],B);w++}else if(L.isDirectionalLight){const O=e.get(L);if(O.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){const V=L.shadow,D=n.get(L);D.shadowIntensity=V.intensity,D.shadowBias=V.bias,D.shadowNormalBias=V.normalBias,D.shadowRadius=V.radius,D.shadowMapSize=V.mapSize,i.directionalShadow[p]=D,i.directionalShadowMap[p]=Q,i.directionalShadowMatrix[p]=L.shadow.matrix,g++}i.directional[p]=O,p++}else if(L.isSpotLight){const O=e.get(L);O.position.setFromMatrixPosition(L.matrixWorld),O.color.copy(z).multiplyScalar(B),O.distance=I,O.coneCos=Math.cos(L.angle),O.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),O.decay=L.decay,i.spot[S]=O;const V=L.shadow;if(L.map&&(i.spotLightMap[R]=L.map,R++,V.updateMatrices(L),L.castShadow&&A++),i.spotLightMatrix[S]=V.matrix,L.castShadow){const D=n.get(L);D.shadowIntensity=V.intensity,D.shadowBias=V.bias,D.shadowNormalBias=V.normalBias,D.shadowRadius=V.radius,D.shadowMapSize=V.mapSize,i.spotShadow[S]=D,i.spotShadowMap[S]=Q,y++}S++}else if(L.isRectAreaLight){const O=e.get(L);O.color.copy(z).multiplyScalar(B),O.halfWidth.set(L.width*.5,0,0),O.halfHeight.set(0,L.height*.5,0),i.rectArea[m]=O,m++}else if(L.isPointLight){const O=e.get(L);if(O.color.copy(L.color).multiplyScalar(L.intensity),O.distance=L.distance,O.decay=L.decay,L.castShadow){const V=L.shadow,D=n.get(L);D.shadowIntensity=V.intensity,D.shadowBias=V.bias,D.shadowNormalBias=V.normalBias,D.shadowRadius=V.radius,D.shadowMapSize=V.mapSize,D.shadowCameraNear=V.camera.near,D.shadowCameraFar=V.camera.far,i.pointShadow[x]=D,i.pointShadowMap[x]=Q,i.pointShadowMatrix[x]=L.shadow.matrix,_++}i.point[x]=O,x++}else if(L.isHemisphereLight){const O=e.get(L);O.skyColor.copy(L.color).multiplyScalar(B),O.groundColor.copy(L.groundColor).multiplyScalar(B),i.hemi[u]=O,u++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ue.LTC_FLOAT_1,i.rectAreaLTC2=ue.LTC_FLOAT_2):(i.rectAreaLTC1=ue.LTC_HALF_1,i.rectAreaLTC2=ue.LTC_HALF_2)),i.ambient[0]=d,i.ambient[1]=h,i.ambient[2]=f;const N=i.hash;(N.directionalLength!==p||N.pointLength!==x||N.spotLength!==S||N.rectAreaLength!==m||N.hemiLength!==u||N.numDirectionalShadows!==g||N.numPointShadows!==_||N.numSpotShadows!==y||N.numSpotMaps!==R||N.numLightProbes!==w)&&(i.directional.length=p,i.spot.length=S,i.rectArea.length=m,i.point.length=x,i.hemi.length=u,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=_,i.pointShadowMap.length=_,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=_,i.spotLightMatrix.length=y+R-A,i.spotLightMap.length=R,i.numSpotLightShadowsWithMaps=A,i.numLightProbes=w,N.directionalLength=p,N.pointLength=x,N.spotLength=S,N.rectAreaLength=m,N.hemiLength=u,N.numDirectionalShadows=g,N.numPointShadows=_,N.numSpotShadows=y,N.numSpotMaps=R,N.numLightProbes=w,i.version=r3++)}function l(c,d){let h=0,f=0,p=0,x=0,S=0;const m=d.matrixWorldInverse;for(let u=0,g=c.length;u<g;u++){const _=c[u];if(_.isDirectionalLight){const y=i.directional[h];y.direction.setFromMatrixPosition(_.matrixWorld),a.setFromMatrixPosition(_.target.matrixWorld),y.direction.sub(a),y.direction.transformDirection(m),h++}else if(_.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(_.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(_.matrixWorld),a.setFromMatrixPosition(_.target.matrixWorld),y.direction.sub(a),y.direction.transformDirection(m),p++}else if(_.isRectAreaLight){const y=i.rectArea[x];y.position.setFromMatrixPosition(_.matrixWorld),y.position.applyMatrix4(m),s.identity(),r.copy(_.matrixWorld),r.premultiply(m),s.extractRotation(r),y.halfWidth.set(_.width*.5,0,0),y.halfHeight.set(0,_.height*.5,0),y.halfWidth.applyMatrix4(s),y.halfHeight.applyMatrix4(s),x++}else if(_.isPointLight){const y=i.point[f];y.position.setFromMatrixPosition(_.matrixWorld),y.position.applyMatrix4(m),f++}else if(_.isHemisphereLight){const y=i.hemi[S];y.direction.setFromMatrixPosition(_.matrixWorld),y.direction.transformDirection(m),S++}}}return{setup:o,setupView:l,state:i}}function R0(t){const e=new o3(t),n=[],i=[];function a(d){c.camera=d,n.length=0,i.length=0}function r(d){n.push(d)}function s(d){i.push(d)}function o(){e.setup(n)}function l(d){e.setupView(n,d)}const c={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:a,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:s}}function l3(t){let e=new WeakMap;function n(a,r=0){const s=e.get(a);let o;return s===void 0?(o=new R0(t),e.set(a,[o])):r>=s.length?(o=new R0(t),s.push(o)):o=s[r],o}function i(){e=new WeakMap}return{get:n,dispose:i}}const c3=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function f3(t,e,n){let i=new kp;const a=new at,r=new at,s=new Dt,o=new zA({depthPacking:YT}),l=new BA,c={},d=n.maxTextureSize,h={[Na]:gn,[gn]:Na,[$n]:$n},f=new Da({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new at},radius:{value:4}},vertexShader:c3,fragmentShader:u3}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const x=new Ki;x.setAttribute("position",new hi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new ti(x,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=qx;let u=this.type;this.render=function(A,w,N){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const T=t.getRenderTarget(),E=t.getActiveCubeFace(),L=t.getActiveMipmapLevel(),z=t.state;z.setBlending(Ta),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const B=u!==Ci&&this.type===Ci,I=u===Ci&&this.type!==Ci;for(let Q=0,O=A.length;Q<O;Q++){const V=A[Q],D=V.shadow;if(D===void 0){console.warn("THREE.WebGLShadowMap:",V,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;a.copy(D.mapSize);const q=D.getFrameExtents();if(a.multiply(q),r.copy(D.mapSize),(a.x>d||a.y>d)&&(a.x>d&&(r.x=Math.floor(d/q.x),a.x=r.x*q.x,D.mapSize.x=r.x),a.y>d&&(r.y=Math.floor(d/q.y),a.y=r.y*q.y,D.mapSize.y=r.y)),D.map===null||B===!0||I===!0){const ae=this.type!==Ci?{minFilter:ii,magFilter:ii}:{};D.map!==null&&D.map.dispose(),D.map=new ur(a.x,a.y,ae),D.map.texture.name=V.name+".shadowMap",D.camera.updateProjectionMatrix()}t.setRenderTarget(D.map),t.clear();const Z=D.getViewportCount();for(let ae=0;ae<Z;ae++){const Re=D.getViewport(ae);s.set(r.x*Re.x,r.y*Re.y,r.x*Re.z,r.y*Re.w),z.viewport(s),D.updateMatrices(V,ae),i=D.getFrustum(),y(w,N,D.camera,V,this.type)}D.isPointLightShadow!==!0&&this.type===Ci&&g(D,N),D.needsUpdate=!1}u=this.type,m.needsUpdate=!1,t.setRenderTarget(T,E,L)};function g(A,w){const N=e.update(S);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new ur(a.x,a.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(w,null,N,f,S,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(w,null,N,p,S,null)}function _(A,w,N,T){let E=null;const L=N.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(L!==void 0)E=L;else if(E=N.isPointLight===!0?l:o,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const z=E.uuid,B=w.uuid;let I=c[z];I===void 0&&(I={},c[z]=I);let Q=I[B];Q===void 0&&(Q=E.clone(),I[B]=Q,w.addEventListener("dispose",R)),E=Q}if(E.visible=w.visible,E.wireframe=w.wireframe,T===Ci?E.side=w.shadowSide!==null?w.shadowSide:w.side:E.side=w.shadowSide!==null?w.shadowSide:h[w.side],E.alphaMap=w.alphaMap,E.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,E.map=w.map,E.clipShadows=w.clipShadows,E.clippingPlanes=w.clippingPlanes,E.clipIntersection=w.clipIntersection,E.displacementMap=w.displacementMap,E.displacementScale=w.displacementScale,E.displacementBias=w.displacementBias,E.wireframeLinewidth=w.wireframeLinewidth,E.linewidth=w.linewidth,N.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const z=t.properties.get(E);z.light=N}return E}function y(A,w,N,T,E){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&E===Ci)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,A.matrixWorld);const B=e.update(A),I=A.material;if(Array.isArray(I)){const Q=B.groups;for(let O=0,V=Q.length;O<V;O++){const D=Q[O],q=I[D.materialIndex];if(q&&q.visible){const Z=_(A,q,T,E);A.onBeforeShadow(t,A,w,N,B,Z,D),t.renderBufferDirect(N,null,B,Z,A,D),A.onAfterShadow(t,A,w,N,B,Z,D)}}}else if(I.visible){const Q=_(A,I,T,E);A.onBeforeShadow(t,A,w,N,B,Q,null),t.renderBufferDirect(N,null,B,Q,A,null),A.onAfterShadow(t,A,w,N,B,Q,null)}}const z=A.children;for(let B=0,I=z.length;B<I;B++)y(z[B],w,N,T,E)}function R(A){A.target.removeEventListener("dispose",R);for(const N in c){const T=c[N],E=A.target.uuid;E in T&&(T[E].dispose(),delete T[E])}}}const d3={[Hd]:Gd,[Vd]:Xd,[kd]:Wd,[_s]:jd,[Gd]:Hd,[Xd]:Vd,[Wd]:kd,[jd]:_s};function h3(t,e){function n(){let P=!1;const de=new Dt;let re=null;const ve=new Dt(0,0,0,0);return{setMask:function(se){re!==se&&!P&&(t.colorMask(se,se,se,se),re=se)},setLocked:function(se){P=se},setClear:function(se,te,_e,Be,_t){_t===!0&&(se*=Be,te*=Be,_e*=Be),de.set(se,te,_e,Be),ve.equals(de)===!1&&(t.clearColor(se,te,_e,Be),ve.copy(de))},reset:function(){P=!1,re=null,ve.set(-1,0,0,0)}}}function i(){let P=!1,de=!1,re=null,ve=null,se=null;return{setReversed:function(te){if(de!==te){const _e=e.get("EXT_clip_control");te?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),de=te;const Be=se;se=null,this.setClear(Be)}},getReversed:function(){return de},setTest:function(te){te?le(t.DEPTH_TEST):ye(t.DEPTH_TEST)},setMask:function(te){re!==te&&!P&&(t.depthMask(te),re=te)},setFunc:function(te){if(de&&(te=d3[te]),ve!==te){switch(te){case Hd:t.depthFunc(t.NEVER);break;case Gd:t.depthFunc(t.ALWAYS);break;case Vd:t.depthFunc(t.LESS);break;case _s:t.depthFunc(t.LEQUAL);break;case kd:t.depthFunc(t.EQUAL);break;case jd:t.depthFunc(t.GEQUAL);break;case Xd:t.depthFunc(t.GREATER);break;case Wd:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ve=te}},setLocked:function(te){P=te},setClear:function(te){se!==te&&(de&&(te=1-te),t.clearDepth(te),se=te)},reset:function(){P=!1,re=null,ve=null,se=null,de=!1}}}function a(){let P=!1,de=null,re=null,ve=null,se=null,te=null,_e=null,Be=null,_t=null;return{setTest:function(st){P||(st?le(t.STENCIL_TEST):ye(t.STENCIL_TEST))},setMask:function(st){de!==st&&!P&&(t.stencilMask(st),de=st)},setFunc:function(st,qn,yi){(re!==st||ve!==qn||se!==yi)&&(t.stencilFunc(st,qn,yi),re=st,ve=qn,se=yi)},setOp:function(st,qn,yi){(te!==st||_e!==qn||Be!==yi)&&(t.stencilOp(st,qn,yi),te=st,_e=qn,Be=yi)},setLocked:function(st){P=st},setClear:function(st){_t!==st&&(t.clearStencil(st),_t=st)},reset:function(){P=!1,de=null,re=null,ve=null,se=null,te=null,_e=null,Be=null,_t=null}}}const r=new n,s=new i,o=new a,l=new WeakMap,c=new WeakMap;let d={},h={},f=new WeakMap,p=[],x=null,S=!1,m=null,u=null,g=null,_=null,y=null,R=null,A=null,w=new $e(0,0,0),N=0,T=!1,E=null,L=null,z=null,B=null,I=null;const Q=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,V=0;const D=t.getParameter(t.VERSION);D.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(D)[1]),O=V>=1):D.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(D)[1]),O=V>=2);let q=null,Z={};const ae=t.getParameter(t.SCISSOR_BOX),Re=t.getParameter(t.VIEWPORT),Ve=new Dt().fromArray(ae),Y=new Dt().fromArray(Re);function J(P,de,re,ve){const se=new Uint8Array(4),te=t.createTexture();t.bindTexture(P,te),t.texParameteri(P,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(P,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let _e=0;_e<re;_e++)P===t.TEXTURE_3D||P===t.TEXTURE_2D_ARRAY?t.texImage3D(de,0,t.RGBA,1,1,ve,0,t.RGBA,t.UNSIGNED_BYTE,se):t.texImage2D(de+_e,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,se);return te}const pe={};pe[t.TEXTURE_2D]=J(t.TEXTURE_2D,t.TEXTURE_2D,1),pe[t.TEXTURE_CUBE_MAP]=J(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),pe[t.TEXTURE_2D_ARRAY]=J(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),pe[t.TEXTURE_3D]=J(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),le(t.DEPTH_TEST),s.setFunc(_s),Qe(!1),mt(Ug),le(t.CULL_FACE),U(Ta);function le(P){d[P]!==!0&&(t.enable(P),d[P]=!0)}function ye(P){d[P]!==!1&&(t.disable(P),d[P]=!1)}function Me(P,de){return h[P]!==de?(t.bindFramebuffer(P,de),h[P]=de,P===t.DRAW_FRAMEBUFFER&&(h[t.FRAMEBUFFER]=de),P===t.FRAMEBUFFER&&(h[t.DRAW_FRAMEBUFFER]=de),!0):!1}function be(P,de){let re=p,ve=!1;if(P){re=f.get(de),re===void 0&&(re=[],f.set(de,re));const se=P.textures;if(re.length!==se.length||re[0]!==t.COLOR_ATTACHMENT0){for(let te=0,_e=se.length;te<_e;te++)re[te]=t.COLOR_ATTACHMENT0+te;re.length=se.length,ve=!0}}else re[0]!==t.BACK&&(re[0]=t.BACK,ve=!0);ve&&t.drawBuffers(re)}function We(P){return x!==P?(t.useProgram(P),x=P,!0):!1}const vt={[Ya]:t.FUNC_ADD,[yT]:t.FUNC_SUBTRACT,[ST]:t.FUNC_REVERSE_SUBTRACT};vt[MT]=t.MIN,vt[ET]=t.MAX;const Ke={[bT]:t.ZERO,[TT]:t.ONE,[AT]:t.SRC_COLOR,[Id]:t.SRC_ALPHA,[UT]:t.SRC_ALPHA_SATURATE,[NT]:t.DST_COLOR,[RT]:t.DST_ALPHA,[wT]:t.ONE_MINUS_SRC_COLOR,[Fd]:t.ONE_MINUS_SRC_ALPHA,[DT]:t.ONE_MINUS_DST_COLOR,[CT]:t.ONE_MINUS_DST_ALPHA,[LT]:t.CONSTANT_COLOR,[OT]:t.ONE_MINUS_CONSTANT_COLOR,[PT]:t.CONSTANT_ALPHA,[zT]:t.ONE_MINUS_CONSTANT_ALPHA};function U(P,de,re,ve,se,te,_e,Be,_t,st){if(P===Ta){S===!0&&(ye(t.BLEND),S=!1);return}if(S===!1&&(le(t.BLEND),S=!0),P!==xT){if(P!==m||st!==T){if((u!==Ya||y!==Ya)&&(t.blendEquation(t.FUNC_ADD),u=Ya,y=Ya),st)switch(P){case as:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Lg:t.blendFunc(t.ONE,t.ONE);break;case Og:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Pg:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case as:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Lg:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Og:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Pg:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}g=null,_=null,R=null,A=null,w.set(0,0,0),N=0,m=P,T=st}return}se=se||de,te=te||re,_e=_e||ve,(de!==u||se!==y)&&(t.blendEquationSeparate(vt[de],vt[se]),u=de,y=se),(re!==g||ve!==_||te!==R||_e!==A)&&(t.blendFuncSeparate(Ke[re],Ke[ve],Ke[te],Ke[_e]),g=re,_=ve,R=te,A=_e),(Be.equals(w)===!1||_t!==N)&&(t.blendColor(Be.r,Be.g,Be.b,_t),w.copy(Be),N=_t),m=P,T=!1}function jt(P,de){P.side===$n?ye(t.CULL_FACE):le(t.CULL_FACE);let re=P.side===gn;de&&(re=!re),Qe(re),P.blending===as&&P.transparent===!1?U(Ta):U(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),s.setFunc(P.depthFunc),s.setTest(P.depthTest),s.setMask(P.depthWrite),r.setMask(P.colorWrite);const ve=P.stencilWrite;o.setTest(ve),ve&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Je(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?le(t.SAMPLE_ALPHA_TO_COVERAGE):ye(t.SAMPLE_ALPHA_TO_COVERAGE)}function Qe(P){E!==P&&(P?t.frontFace(t.CW):t.frontFace(t.CCW),E=P)}function mt(P){P!==vT?(le(t.CULL_FACE),P!==L&&(P===Ug?t.cullFace(t.BACK):P===_T?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):ye(t.CULL_FACE),L=P}function Ee(P){P!==z&&(O&&t.lineWidth(P),z=P)}function Je(P,de,re){P?(le(t.POLYGON_OFFSET_FILL),(B!==de||I!==re)&&(t.polygonOffset(de,re),B=de,I=re)):ye(t.POLYGON_OFFSET_FILL)}function Ce(P){P?le(t.SCISSOR_TEST):ye(t.SCISSOR_TEST)}function Fe(P){P===void 0&&(P=t.TEXTURE0+Q-1),q!==P&&(t.activeTexture(P),q=P)}function It(P,de,re){re===void 0&&(q===null?re=t.TEXTURE0+Q-1:re=q);let ve=Z[re];ve===void 0&&(ve={type:void 0,texture:void 0},Z[re]=ve),(ve.type!==P||ve.texture!==de)&&(q!==re&&(t.activeTexture(re),q=re),t.bindTexture(P,de||pe[P]),ve.type=P,ve.texture=de)}function C(){const P=Z[q];P!==void 0&&P.type!==void 0&&(t.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function M(){try{t.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function k(){try{t.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{t.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ne(){try{t.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{t.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Te(){try{t.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function fe(){try{t.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Se(){try{t.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ae(){try{t.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ie(){try{t.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function me(P){Ve.equals(P)===!1&&(t.scissor(P.x,P.y,P.z,P.w),Ve.copy(P))}function Ue(P){Y.equals(P)===!1&&(t.viewport(P.x,P.y,P.z,P.w),Y.copy(P))}function De(P,de){let re=c.get(de);re===void 0&&(re=new WeakMap,c.set(de,re));let ve=re.get(P);ve===void 0&&(ve=t.getUniformBlockIndex(de,P.name),re.set(P,ve))}function ce(P,de){const ve=c.get(de).get(P);l.get(de)!==ve&&(t.uniformBlockBinding(de,ve,P.__bindingPointIndex),l.set(de,ve))}function ze(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),s.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),d={},q=null,Z={},h={},f=new WeakMap,p=[],x=null,S=!1,m=null,u=null,g=null,_=null,y=null,R=null,A=null,w=new $e(0,0,0),N=0,T=!1,E=null,L=null,z=null,B=null,I=null,Ve.set(0,0,t.canvas.width,t.canvas.height),Y.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:le,disable:ye,bindFramebuffer:Me,drawBuffers:be,useProgram:We,setBlending:U,setMaterial:jt,setFlipSided:Qe,setCullFace:mt,setLineWidth:Ee,setPolygonOffset:Je,setScissorTest:Ce,activeTexture:Fe,bindTexture:It,unbindTexture:C,compressedTexImage2D:M,compressedTexImage3D:k,texImage2D:Ae,texImage3D:ie,updateUBOMapping:De,uniformBlockBinding:ce,texStorage2D:fe,texStorage3D:Se,texSubImage2D:$,texSubImage3D:ne,compressedTexSubImage2D:K,compressedTexSubImage3D:Te,scissor:me,viewport:Ue,reset:ze}}function p3(t,e,n,i,a,r,s){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new at,d=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(C,M){return p?new OffscreenCanvas(C,M):qc("canvas")}function S(C,M,k){let $=1;const ne=It(C);if((ne.width>k||ne.height>k)&&($=k/Math.max(ne.width,ne.height)),$<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const K=Math.floor($*ne.width),Te=Math.floor($*ne.height);h===void 0&&(h=x(K,Te));const fe=M?x(K,Te):h;return fe.width=K,fe.height=Te,fe.getContext("2d").drawImage(C,0,0,K,Te),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+K+"x"+Te+")."),fe}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),C;return C}function m(C){return C.generateMipmaps}function u(C){t.generateMipmap(C)}function g(C){return C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?t.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function _(C,M,k,$,ne=!1){if(C!==null){if(t[C]!==void 0)return t[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let K=M;if(M===t.RED&&(k===t.FLOAT&&(K=t.R32F),k===t.HALF_FLOAT&&(K=t.R16F),k===t.UNSIGNED_BYTE&&(K=t.R8)),M===t.RED_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.R8UI),k===t.UNSIGNED_SHORT&&(K=t.R16UI),k===t.UNSIGNED_INT&&(K=t.R32UI),k===t.BYTE&&(K=t.R8I),k===t.SHORT&&(K=t.R16I),k===t.INT&&(K=t.R32I)),M===t.RG&&(k===t.FLOAT&&(K=t.RG32F),k===t.HALF_FLOAT&&(K=t.RG16F),k===t.UNSIGNED_BYTE&&(K=t.RG8)),M===t.RG_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.RG8UI),k===t.UNSIGNED_SHORT&&(K=t.RG16UI),k===t.UNSIGNED_INT&&(K=t.RG32UI),k===t.BYTE&&(K=t.RG8I),k===t.SHORT&&(K=t.RG16I),k===t.INT&&(K=t.RG32I)),M===t.RGB_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.RGB8UI),k===t.UNSIGNED_SHORT&&(K=t.RGB16UI),k===t.UNSIGNED_INT&&(K=t.RGB32UI),k===t.BYTE&&(K=t.RGB8I),k===t.SHORT&&(K=t.RGB16I),k===t.INT&&(K=t.RGB32I)),M===t.RGBA_INTEGER&&(k===t.UNSIGNED_BYTE&&(K=t.RGBA8UI),k===t.UNSIGNED_SHORT&&(K=t.RGBA16UI),k===t.UNSIGNED_INT&&(K=t.RGBA32UI),k===t.BYTE&&(K=t.RGBA8I),k===t.SHORT&&(K=t.RGBA16I),k===t.INT&&(K=t.RGBA32I)),M===t.RGB&&k===t.UNSIGNED_INT_5_9_9_9_REV&&(K=t.RGB9_E5),M===t.RGBA){const Te=ne?Xc:tt.getTransfer($);k===t.FLOAT&&(K=t.RGBA32F),k===t.HALF_FLOAT&&(K=t.RGBA16F),k===t.UNSIGNED_BYTE&&(K=Te===ut?t.SRGB8_ALPHA8:t.RGBA8),k===t.UNSIGNED_SHORT_4_4_4_4&&(K=t.RGBA4),k===t.UNSIGNED_SHORT_5_5_5_1&&(K=t.RGB5_A1)}return(K===t.R16F||K===t.R32F||K===t.RG16F||K===t.RG32F||K===t.RGBA16F||K===t.RGBA32F)&&e.get("EXT_color_buffer_float"),K}function y(C,M){let k;return C?M===null||M===cr||M===Uo?k=t.DEPTH24_STENCIL8:M===zi?k=t.DEPTH32F_STENCIL8:M===Do&&(k=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===cr||M===Uo?k=t.DEPTH_COMPONENT24:M===zi?k=t.DEPTH_COMPONENT32F:M===Do&&(k=t.DEPTH_COMPONENT16),k}function R(C,M){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==ii&&C.minFilter!==ci?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function A(C){const M=C.target;M.removeEventListener("dispose",A),N(M),M.isVideoTexture&&d.delete(M)}function w(C){const M=C.target;M.removeEventListener("dispose",w),E(M)}function N(C){const M=i.get(C);if(M.__webglInit===void 0)return;const k=C.source,$=f.get(k);if($){const ne=$[M.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&T(C),Object.keys($).length===0&&f.delete(k)}i.remove(C)}function T(C){const M=i.get(C);t.deleteTexture(M.__webglTexture);const k=C.source,$=f.get(k);delete $[M.__cacheKey],s.memory.textures--}function E(C){const M=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(M.__webglFramebuffer[$]))for(let ne=0;ne<M.__webglFramebuffer[$].length;ne++)t.deleteFramebuffer(M.__webglFramebuffer[$][ne]);else t.deleteFramebuffer(M.__webglFramebuffer[$]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[$])}else{if(Array.isArray(M.__webglFramebuffer))for(let $=0;$<M.__webglFramebuffer.length;$++)t.deleteFramebuffer(M.__webglFramebuffer[$]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let $=0;$<M.__webglColorRenderbuffer.length;$++)M.__webglColorRenderbuffer[$]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[$]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const k=C.textures;for(let $=0,ne=k.length;$<ne;$++){const K=i.get(k[$]);K.__webglTexture&&(t.deleteTexture(K.__webglTexture),s.memory.textures--),i.remove(k[$])}i.remove(C)}let L=0;function z(){L=0}function B(){const C=L;return C>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+a.maxTextures),L+=1,C}function I(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function Q(C,M){const k=i.get(C);if(C.isVideoTexture&&Ce(C),C.isRenderTargetTexture===!1&&C.version>0&&k.__version!==C.version){const $=C.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{pe(k,C,M);return}}n.bindTexture(t.TEXTURE_2D,k.__webglTexture,t.TEXTURE0+M)}function O(C,M){const k=i.get(C);if(C.version>0&&k.__version!==C.version){pe(k,C,M);return}n.bindTexture(t.TEXTURE_2D_ARRAY,k.__webglTexture,t.TEXTURE0+M)}function V(C,M){const k=i.get(C);if(C.version>0&&k.__version!==C.version){pe(k,C,M);return}n.bindTexture(t.TEXTURE_3D,k.__webglTexture,t.TEXTURE0+M)}function D(C,M){const k=i.get(C);if(C.version>0&&k.__version!==C.version){le(k,C,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,k.__webglTexture,t.TEXTURE0+M)}const q={[Zd]:t.REPEAT,[Ka]:t.CLAMP_TO_EDGE,[Kd]:t.MIRRORED_REPEAT},Z={[ii]:t.NEAREST,[WT]:t.NEAREST_MIPMAP_NEAREST,[bl]:t.NEAREST_MIPMAP_LINEAR,[ci]:t.LINEAR,[sf]:t.LINEAR_MIPMAP_NEAREST,[Qa]:t.LINEAR_MIPMAP_LINEAR},ae={[KT]:t.NEVER,[nA]:t.ALWAYS,[QT]:t.LESS,[ay]:t.LEQUAL,[$T]:t.EQUAL,[tA]:t.GEQUAL,[JT]:t.GREATER,[eA]:t.NOTEQUAL};function Re(C,M){if(M.type===zi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===ci||M.magFilter===sf||M.magFilter===bl||M.magFilter===Qa||M.minFilter===ci||M.minFilter===sf||M.minFilter===bl||M.minFilter===Qa)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,q[M.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,q[M.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,q[M.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,Z[M.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,Z[M.minFilter]),M.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,ae[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===ii||M.minFilter!==bl&&M.minFilter!==Qa||M.type===zi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,a.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function Ve(C,M){let k=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",A));const $=M.source;let ne=f.get($);ne===void 0&&(ne={},f.set($,ne));const K=I(M);if(K!==C.__cacheKey){ne[K]===void 0&&(ne[K]={texture:t.createTexture(),usedTimes:0},s.memory.textures++,k=!0),ne[K].usedTimes++;const Te=ne[C.__cacheKey];Te!==void 0&&(ne[C.__cacheKey].usedTimes--,Te.usedTimes===0&&T(M)),C.__cacheKey=K,C.__webglTexture=ne[K].texture}return k}function Y(C,M,k){return Math.floor(Math.floor(C/k)/M)}function J(C,M,k,$){const K=C.updateRanges;if(K.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,M.width,M.height,k,$,M.data);else{K.sort((ie,me)=>ie.start-me.start);let Te=0;for(let ie=1;ie<K.length;ie++){const me=K[Te],Ue=K[ie],De=me.start+me.count,ce=Y(Ue.start,M.width,4),ze=Y(me.start,M.width,4);Ue.start<=De+1&&ce===ze&&Y(Ue.start+Ue.count-1,M.width,4)===ce?me.count=Math.max(me.count,Ue.start+Ue.count-me.start):(++Te,K[Te]=Ue)}K.length=Te+1;const fe=t.getParameter(t.UNPACK_ROW_LENGTH),Se=t.getParameter(t.UNPACK_SKIP_PIXELS),Ae=t.getParameter(t.UNPACK_SKIP_ROWS);t.pixelStorei(t.UNPACK_ROW_LENGTH,M.width);for(let ie=0,me=K.length;ie<me;ie++){const Ue=K[ie],De=Math.floor(Ue.start/4),ce=Math.ceil(Ue.count/4),ze=De%M.width,P=Math.floor(De/M.width),de=ce,re=1;t.pixelStorei(t.UNPACK_SKIP_PIXELS,ze),t.pixelStorei(t.UNPACK_SKIP_ROWS,P),n.texSubImage2D(t.TEXTURE_2D,0,ze,P,de,re,k,$,M.data)}C.clearUpdateRanges(),t.pixelStorei(t.UNPACK_ROW_LENGTH,fe),t.pixelStorei(t.UNPACK_SKIP_PIXELS,Se),t.pixelStorei(t.UNPACK_SKIP_ROWS,Ae)}}function pe(C,M,k){let $=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&($=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&($=t.TEXTURE_3D);const ne=Ve(C,M),K=M.source;n.bindTexture($,C.__webglTexture,t.TEXTURE0+k);const Te=i.get(K);if(K.version!==Te.__version||ne===!0){n.activeTexture(t.TEXTURE0+k);const fe=tt.getPrimaries(tt.workingColorSpace),Se=M.colorSpace===da?null:tt.getPrimaries(M.colorSpace),Ae=M.colorSpace===da||fe===Se?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let ie=S(M.image,!1,a.maxTextureSize);ie=Fe(M,ie);const me=r.convert(M.format,M.colorSpace),Ue=r.convert(M.type);let De=_(M.internalFormat,me,Ue,M.colorSpace,M.isVideoTexture);Re($,M);let ce;const ze=M.mipmaps,P=M.isVideoTexture!==!0,de=Te.__version===void 0||ne===!0,re=K.dataReady,ve=R(M,ie);if(M.isDepthTexture)De=y(M.format===Oo,M.type),de&&(P?n.texStorage2D(t.TEXTURE_2D,1,De,ie.width,ie.height):n.texImage2D(t.TEXTURE_2D,0,De,ie.width,ie.height,0,me,Ue,null));else if(M.isDataTexture)if(ze.length>0){P&&de&&n.texStorage2D(t.TEXTURE_2D,ve,De,ze[0].width,ze[0].height);for(let se=0,te=ze.length;se<te;se++)ce=ze[se],P?re&&n.texSubImage2D(t.TEXTURE_2D,se,0,0,ce.width,ce.height,me,Ue,ce.data):n.texImage2D(t.TEXTURE_2D,se,De,ce.width,ce.height,0,me,Ue,ce.data);M.generateMipmaps=!1}else P?(de&&n.texStorage2D(t.TEXTURE_2D,ve,De,ie.width,ie.height),re&&J(M,ie,me,Ue)):n.texImage2D(t.TEXTURE_2D,0,De,ie.width,ie.height,0,me,Ue,ie.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){P&&de&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ve,De,ze[0].width,ze[0].height,ie.depth);for(let se=0,te=ze.length;se<te;se++)if(ce=ze[se],M.format!==ei)if(me!==null)if(P){if(re)if(M.layerUpdates.size>0){const _e=a0(ce.width,ce.height,M.format,M.type);for(const Be of M.layerUpdates){const _t=ce.data.subarray(Be*_e/ce.data.BYTES_PER_ELEMENT,(Be+1)*_e/ce.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,se,0,0,Be,ce.width,ce.height,1,me,_t)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,se,0,0,0,ce.width,ce.height,ie.depth,me,ce.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,se,De,ce.width,ce.height,ie.depth,0,ce.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?re&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,se,0,0,0,ce.width,ce.height,ie.depth,me,Ue,ce.data):n.texImage3D(t.TEXTURE_2D_ARRAY,se,De,ce.width,ce.height,ie.depth,0,me,Ue,ce.data)}else{P&&de&&n.texStorage2D(t.TEXTURE_2D,ve,De,ze[0].width,ze[0].height);for(let se=0,te=ze.length;se<te;se++)ce=ze[se],M.format!==ei?me!==null?P?re&&n.compressedTexSubImage2D(t.TEXTURE_2D,se,0,0,ce.width,ce.height,me,ce.data):n.compressedTexImage2D(t.TEXTURE_2D,se,De,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?re&&n.texSubImage2D(t.TEXTURE_2D,se,0,0,ce.width,ce.height,me,Ue,ce.data):n.texImage2D(t.TEXTURE_2D,se,De,ce.width,ce.height,0,me,Ue,ce.data)}else if(M.isDataArrayTexture)if(P){if(de&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ve,De,ie.width,ie.height,ie.depth),re)if(M.layerUpdates.size>0){const se=a0(ie.width,ie.height,M.format,M.type);for(const te of M.layerUpdates){const _e=ie.data.subarray(te*se/ie.data.BYTES_PER_ELEMENT,(te+1)*se/ie.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,te,ie.width,ie.height,1,me,Ue,_e)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,me,Ue,ie.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,De,ie.width,ie.height,ie.depth,0,me,Ue,ie.data);else if(M.isData3DTexture)P?(de&&n.texStorage3D(t.TEXTURE_3D,ve,De,ie.width,ie.height,ie.depth),re&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,me,Ue,ie.data)):n.texImage3D(t.TEXTURE_3D,0,De,ie.width,ie.height,ie.depth,0,me,Ue,ie.data);else if(M.isFramebufferTexture){if(de)if(P)n.texStorage2D(t.TEXTURE_2D,ve,De,ie.width,ie.height);else{let se=ie.width,te=ie.height;for(let _e=0;_e<ve;_e++)n.texImage2D(t.TEXTURE_2D,_e,De,se,te,0,me,Ue,null),se>>=1,te>>=1}}else if(ze.length>0){if(P&&de){const se=It(ze[0]);n.texStorage2D(t.TEXTURE_2D,ve,De,se.width,se.height)}for(let se=0,te=ze.length;se<te;se++)ce=ze[se],P?re&&n.texSubImage2D(t.TEXTURE_2D,se,0,0,me,Ue,ce):n.texImage2D(t.TEXTURE_2D,se,De,me,Ue,ce);M.generateMipmaps=!1}else if(P){if(de){const se=It(ie);n.texStorage2D(t.TEXTURE_2D,ve,De,se.width,se.height)}re&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,me,Ue,ie)}else n.texImage2D(t.TEXTURE_2D,0,De,me,Ue,ie);m(M)&&u($),Te.__version=K.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function le(C,M,k){if(M.image.length!==6)return;const $=Ve(C,M),ne=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+k);const K=i.get(ne);if(ne.version!==K.__version||$===!0){n.activeTexture(t.TEXTURE0+k);const Te=tt.getPrimaries(tt.workingColorSpace),fe=M.colorSpace===da?null:tt.getPrimaries(M.colorSpace),Se=M.colorSpace===da||Te===fe?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);const Ae=M.isCompressedTexture||M.image[0].isCompressedTexture,ie=M.image[0]&&M.image[0].isDataTexture,me=[];for(let te=0;te<6;te++)!Ae&&!ie?me[te]=S(M.image[te],!0,a.maxCubemapSize):me[te]=ie?M.image[te].image:M.image[te],me[te]=Fe(M,me[te]);const Ue=me[0],De=r.convert(M.format,M.colorSpace),ce=r.convert(M.type),ze=_(M.internalFormat,De,ce,M.colorSpace),P=M.isVideoTexture!==!0,de=K.__version===void 0||$===!0,re=ne.dataReady;let ve=R(M,Ue);Re(t.TEXTURE_CUBE_MAP,M);let se;if(Ae){P&&de&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ve,ze,Ue.width,Ue.height);for(let te=0;te<6;te++){se=me[te].mipmaps;for(let _e=0;_e<se.length;_e++){const Be=se[_e];M.format!==ei?De!==null?P?re&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e,0,0,Be.width,Be.height,De,Be.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e,ze,Be.width,Be.height,0,Be.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?re&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e,0,0,Be.width,Be.height,De,ce,Be.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e,ze,Be.width,Be.height,0,De,ce,Be.data)}}}else{if(se=M.mipmaps,P&&de){se.length>0&&ve++;const te=It(me[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ve,ze,te.width,te.height)}for(let te=0;te<6;te++)if(ie){P?re&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,me[te].width,me[te].height,De,ce,me[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,ze,me[te].width,me[te].height,0,De,ce,me[te].data);for(let _e=0;_e<se.length;_e++){const _t=se[_e].image[te].image;P?re&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e+1,0,0,_t.width,_t.height,De,ce,_t.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e+1,ze,_t.width,_t.height,0,De,ce,_t.data)}}else{P?re&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,De,ce,me[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,ze,De,ce,me[te]);for(let _e=0;_e<se.length;_e++){const Be=se[_e];P?re&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e+1,0,0,De,ce,Be.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,_e+1,ze,De,ce,Be.image[te])}}}m(M)&&u(t.TEXTURE_CUBE_MAP),K.__version=ne.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function ye(C,M,k,$,ne,K){const Te=r.convert(k.format,k.colorSpace),fe=r.convert(k.type),Se=_(k.internalFormat,Te,fe,k.colorSpace),Ae=i.get(M),ie=i.get(k);if(ie.__renderTarget=M,!Ae.__hasExternalTextures){const me=Math.max(1,M.width>>K),Ue=Math.max(1,M.height>>K);ne===t.TEXTURE_3D||ne===t.TEXTURE_2D_ARRAY?n.texImage3D(ne,K,Se,me,Ue,M.depth,0,Te,fe,null):n.texImage2D(ne,K,Se,me,Ue,0,Te,fe,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),Je(M)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,$,ne,ie.__webglTexture,0,Ee(M)):(ne===t.TEXTURE_2D||ne>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,$,ne,ie.__webglTexture,K),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Me(C,M,k){if(t.bindRenderbuffer(t.RENDERBUFFER,C),M.depthBuffer){const $=M.depthTexture,ne=$&&$.isDepthTexture?$.type:null,K=y(M.stencilBuffer,ne),Te=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,fe=Ee(M);Je(M)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,fe,K,M.width,M.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,fe,K,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,K,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Te,t.RENDERBUFFER,C)}else{const $=M.textures;for(let ne=0;ne<$.length;ne++){const K=$[ne],Te=r.convert(K.format,K.colorSpace),fe=r.convert(K.type),Se=_(K.internalFormat,Te,fe,K.colorSpace),Ae=Ee(M);k&&Je(M)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ae,Se,M.width,M.height):Je(M)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ae,Se,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,Se,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function be(C,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=i.get(M.depthTexture);$.__renderTarget=M,(!$.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Q(M.depthTexture,0);const ne=$.__webglTexture,K=Ee(M);if(M.depthTexture.format===Lo)Je(M)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ne,0,K):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ne,0);else if(M.depthTexture.format===Oo)Je(M)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ne,0,K):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function We(C){const M=i.get(C),k=C.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==C.depthTexture){const $=C.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),$){const ne=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,$.removeEventListener("dispose",ne)};$.addEventListener("dispose",ne),M.__depthDisposeCallback=ne}M.__boundDepthTexture=$}if(C.depthTexture&&!M.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");const $=C.texture.mipmaps;$&&$.length>0?be(M.__webglFramebuffer[0],C):be(M.__webglFramebuffer,C)}else if(k){M.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[$]),M.__webglDepthbuffer[$]===void 0)M.__webglDepthbuffer[$]=t.createRenderbuffer(),Me(M.__webglDepthbuffer[$],C,!1);else{const ne=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,K=M.__webglDepthbuffer[$];t.bindRenderbuffer(t.RENDERBUFFER,K),t.framebufferRenderbuffer(t.FRAMEBUFFER,ne,t.RENDERBUFFER,K)}}else{const $=C.texture.mipmaps;if($&&$.length>0?n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),Me(M.__webglDepthbuffer,C,!1);else{const ne=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,K=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,K),t.framebufferRenderbuffer(t.FRAMEBUFFER,ne,t.RENDERBUFFER,K)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function vt(C,M,k){const $=i.get(C);M!==void 0&&ye($.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),k!==void 0&&We(C)}function Ke(C){const M=C.texture,k=i.get(C),$=i.get(M);C.addEventListener("dispose",w);const ne=C.textures,K=C.isWebGLCubeRenderTarget===!0,Te=ne.length>1;if(Te||($.__webglTexture===void 0&&($.__webglTexture=t.createTexture()),$.__version=M.version,s.memory.textures++),K){k.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0){k.__webglFramebuffer[fe]=[];for(let Se=0;Se<M.mipmaps.length;Se++)k.__webglFramebuffer[fe][Se]=t.createFramebuffer()}else k.__webglFramebuffer[fe]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){k.__webglFramebuffer=[];for(let fe=0;fe<M.mipmaps.length;fe++)k.__webglFramebuffer[fe]=t.createFramebuffer()}else k.__webglFramebuffer=t.createFramebuffer();if(Te)for(let fe=0,Se=ne.length;fe<Se;fe++){const Ae=i.get(ne[fe]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=t.createTexture(),s.memory.textures++)}if(C.samples>0&&Je(C)===!1){k.__webglMultisampledFramebuffer=t.createFramebuffer(),k.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let fe=0;fe<ne.length;fe++){const Se=ne[fe];k.__webglColorRenderbuffer[fe]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,k.__webglColorRenderbuffer[fe]);const Ae=r.convert(Se.format,Se.colorSpace),ie=r.convert(Se.type),me=_(Se.internalFormat,Ae,ie,Se.colorSpace,C.isXRRenderTarget===!0),Ue=Ee(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,Ue,me,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+fe,t.RENDERBUFFER,k.__webglColorRenderbuffer[fe])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(k.__webglDepthRenderbuffer=t.createRenderbuffer(),Me(k.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(K){n.bindTexture(t.TEXTURE_CUBE_MAP,$.__webglTexture),Re(t.TEXTURE_CUBE_MAP,M);for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0)for(let Se=0;Se<M.mipmaps.length;Se++)ye(k.__webglFramebuffer[fe][Se],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Se);else ye(k.__webglFramebuffer[fe],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);m(M)&&u(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Te){for(let fe=0,Se=ne.length;fe<Se;fe++){const Ae=ne[fe],ie=i.get(Ae);n.bindTexture(t.TEXTURE_2D,ie.__webglTexture),Re(t.TEXTURE_2D,Ae),ye(k.__webglFramebuffer,C,Ae,t.COLOR_ATTACHMENT0+fe,t.TEXTURE_2D,0),m(Ae)&&u(t.TEXTURE_2D)}n.unbindTexture()}else{let fe=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(fe=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(fe,$.__webglTexture),Re(fe,M),M.mipmaps&&M.mipmaps.length>0)for(let Se=0;Se<M.mipmaps.length;Se++)ye(k.__webglFramebuffer[Se],C,M,t.COLOR_ATTACHMENT0,fe,Se);else ye(k.__webglFramebuffer,C,M,t.COLOR_ATTACHMENT0,fe,0);m(M)&&u(fe),n.unbindTexture()}C.depthBuffer&&We(C)}function U(C){const M=C.textures;for(let k=0,$=M.length;k<$;k++){const ne=M[k];if(m(ne)){const K=g(C),Te=i.get(ne).__webglTexture;n.bindTexture(K,Te),u(K),n.unbindTexture()}}}const jt=[],Qe=[];function mt(C){if(C.samples>0){if(Je(C)===!1){const M=C.textures,k=C.width,$=C.height;let ne=t.COLOR_BUFFER_BIT;const K=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Te=i.get(C),fe=M.length>1;if(fe)for(let Ae=0;Ae<M.length;Ae++)n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer);const Se=C.texture.mipmaps;Se&&Se.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Te.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Ae=0;Ae<M.length;Ae++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(ne|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(ne|=t.STENCIL_BUFFER_BIT)),fe){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Te.__webglColorRenderbuffer[Ae]);const ie=i.get(M[Ae]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,ie,0)}t.blitFramebuffer(0,0,k,$,0,0,k,$,ne,t.NEAREST),l===!0&&(jt.length=0,Qe.length=0,jt.push(t.COLOR_ATTACHMENT0+Ae),C.depthBuffer&&C.resolveDepthBuffer===!1&&(jt.push(K),Qe.push(K),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Qe)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,jt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),fe)for(let Ae=0;Ae<M.length;Ae++){n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,Te.__webglColorRenderbuffer[Ae]);const ie=i.get(M[Ae]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,ie,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const M=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function Ee(C){return Math.min(a.maxSamples,C.samples)}function Je(C){const M=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ce(C){const M=s.render.frame;d.get(C)!==M&&(d.set(C,M),C.update())}function Fe(C,M){const k=C.colorSpace,$=C.format,ne=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||k!==Ss&&k!==da&&(tt.getTransfer(k)===ut?($!==ei||ne!==mi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),M}function It(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=z,this.setTexture2D=Q,this.setTexture2DArray=O,this.setTexture3D=V,this.setTextureCube=D,this.rebindTextures=vt,this.setupRenderTarget=Ke,this.updateRenderTargetMipmap=U,this.updateMultisampleRenderTarget=mt,this.setupDepthRenderbuffer=We,this.setupFrameBufferTexture=ye,this.useMultisampledRTT=Je}function m3(t,e){function n(i,a=da){let r;const s=tt.getTransfer(a);if(i===mi)return t.UNSIGNED_BYTE;if(i===zp)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Bp)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Qx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Zx)return t.BYTE;if(i===Kx)return t.SHORT;if(i===Do)return t.UNSIGNED_SHORT;if(i===Pp)return t.INT;if(i===cr)return t.UNSIGNED_INT;if(i===zi)return t.FLOAT;if(i===el)return t.HALF_FLOAT;if(i===$x)return t.ALPHA;if(i===Jx)return t.RGB;if(i===ei)return t.RGBA;if(i===Lo)return t.DEPTH_COMPONENT;if(i===Oo)return t.DEPTH_STENCIL;if(i===ey)return t.RED;if(i===Ip)return t.RED_INTEGER;if(i===ty)return t.RG;if(i===Fp)return t.RG_INTEGER;if(i===Hp)return t.RGBA_INTEGER;if(i===oc||i===lc||i===cc||i===uc)if(s===ut)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===oc)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===lc)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===cc)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===uc)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===oc)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===lc)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===cc)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===uc)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Qd||i===$d||i===Jd||i===eh)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Qd)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===$d)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Jd)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===eh)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===th||i===nh||i===ih)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===th||i===nh)return s===ut?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===ih)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===ah||i===rh||i===sh||i===oh||i===lh||i===ch||i===uh||i===fh||i===dh||i===hh||i===ph||i===mh||i===gh||i===vh)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===ah)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===rh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===sh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===oh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===lh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ch)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===uh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===fh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===dh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===hh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ph)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===mh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===gh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===vh)return s===ut?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===fc||i===_h||i===xh)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===fc)return s===ut?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===_h)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===xh)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ny||i===yh||i===Sh||i===Mh)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===fc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===yh)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Sh)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Mh)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Uo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const g3=`
void main() {
...
}`;class _3{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const a=new vn,r=e.properties.get(a);r.__webglTexture=n.texture,(n.depthNear!==i.depthNear||n.depthFar!==i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=a}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Da({vertexShader:g3,fragmentShader:v3,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new ti(new _u(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class x3 extends Us{constructor(e,n){super();const i=this;let a=null,r=1,s=null,o="local-floor",l=1,c=null,d=null,h=null,f=null,p=null,x=null;const S=new _3,m=n.getContextAttributes();let u=null,g=null;const _=[],y=[],R=new at;let A=null;const w=new wn;w.viewport=new Dt;const N=new wn;N.viewport=new Dt;const T=[w,N],E=new HA;let L=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let J=_[Y];return J===void 0&&(J=new Cf,_[Y]=J),J.getTargetRaySpace()},this.getControllerGrip=function(Y){let J=_[Y];return J===void 0&&(J=new Cf,_[Y]=J),J.getGripSpace()},this.getHand=function(Y){let J=_[Y];return J===void 0&&(J=new Cf,_[Y]=J),J.getHandSpace()};function B(Y){const J=y.indexOf(Y.inputSource);if(J===-1)return;const pe=_[J];pe!==void 0&&(pe.update(Y.inputSource,Y.frame,c||s),pe.dispatchEvent({type:Y.type,data:Y.inputSource}))}function I(){a.removeEventListener("select",B),a.removeEventListener("selectstart",B),a.removeEventListener("selectend",B),a.removeEventListener("squeeze",B),a.removeEventListener("squeezestart",B),a.removeEventListener("squeezeend",B),a.removeEventListener("end",I),a.removeEventListener("inputsourceschange",Q);for(let Y=0;Y<_.length;Y++){const J=y[Y];J!==null&&(y[Y]=null,_[Y].disconnect(J))}L=null,z=null,S.reset(),e.setRenderTarget(u),p=null,f=null,h=null,a=null,g=null,Ve.stop(),i.isPresenting=!1,e.setPixelRatio(A),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){r=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||s},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return x},this.getSession=function(){return a},this.setSession=async function(Y){if(a=Y,a!==null){if(u=e.getRenderTarget(),a.addEventListener("select",B),a.addEventListener("selectstart",B),a.addEventListener("selectend",B),a.addEventListener("squeeze",B),a.addEventListener("squeezestart",B),a.addEventListener("squeezeend",B),a.addEventListener("end",I),a.addEventListener("inputsourceschange",Q),m.xrCompatible!==!0&&await n.makeXRCompatible(),A=e.getPixelRatio(),e.getSize(R),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let pe=null,le=null,ye=null;m.depth&&(ye=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,pe=m.stencil?Oo:Lo,le=m.stencil?Uo:cr);const Me={colorFormat:n.RGBA8,depthFormat:ye,scaleFactor:r};h=new XRWebGLBinding(a,n),f=h.createProjectionLayer(Me),a.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),g=new ur(f.textureWidth,f.textureHeight,{format:ei,type:mi,depthTexture:new gy(f.textureWidth,f.textureHeight,le,void 0,void 0,void 0,void 0,void 0,void 0,pe),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const pe={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(a,n,pe),a.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),g=new ur(p.framebufferWidth,p.framebufferHeight,{format:ei,type:mi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),c=null,s=await a.requestReferenceSpace(o),Ve.setContext(a),Ve.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function Q(Y){for(let J=0;J<Y.removed.length;J++){const pe=Y.removed[J],le=y.indexOf(pe);le>=0&&(y[le]=null,_[le].disconnect(pe))}for(let J=0;J<Y.added.length;J++){const pe=Y.added[J];let le=y.indexOf(pe);if(le===-1){for(let Me=0;Me<_.length;Me++)if(Me>=y.length){y.push(pe),le=Me;break}else if(y[Me]===null){y[Me]=pe,le=Me;break}if(le===-1)break}const ye=_[le];ye&&ye.connect(pe)}}const O=new j,V=new j;function D(Y,J,pe){O.setFromMatrixPosition(J.matrixWorld),V.setFromMatrixPosition(pe.matrixWorld);const le=O.distanceTo(V),ye=J.projectionMatrix.elements,Me=pe.projectionMatrix.elements,be=ye[14]/(ye[10]-1),We=ye[14]/(ye[10]+1),vt=(ye[9]+1)/ye[5],Ke=(ye[9]-1)/ye[5],U=(ye[8]-1)/ye[0],jt=(Me[8]+1)/Me[0],Qe=be*U,mt=be*jt,Ee=le/(-U+jt),Je=Ee*-U;if(J.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(Je),Y.translateZ(Ee),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),ye[10]===-1)Y.projectionMatrix.copy(J.projectionMatrix),Y.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const Ce=be+Ee,Fe=We+Ee,It=Qe-Je,C=mt+(le-Je),M=vt*We/Fe*Ce,k=Ke*We/Fe*Ce;Y.projectionMatrix.makePerspective(It,C,M,k,Ce,Fe),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function q(Y,J){J===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(J.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(a===null)return;let J=Y.near,pe=Y.far;S.texture!==null&&(S.depthNear>0&&(J=S.depthNear),S.depthFar>0&&(pe=S.depthFar)),E.near=N.near=w.near=J,E.far=N.far=w.far=pe,(L!==E.near||z!==E.far)&&(a.updateRenderState({depthNear:E.near,depthFar:E.far}),L=E.near,z=E.far),w.layers.mask=Y.layers.mask|2,N.layers.mask=Y.layers.mask|4,E.layers.mask=w.layers.mask|N.layers.mask;const le=Y.parent,ye=E.cameras;q(E,le);for(let Me=0;Me<ye.length;Me++)q(ye[Me],le);ye.length===2?D(E,w,N):E.projectionMatrix.copy(w.projectionMatrix),Z(Y,E,le)};function Z(Y,J,pe){pe===null?Y.matrix.copy(J.matrixWorld):(Y.matrix.copy(pe.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(J.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(J.projectionMatrix),Y.projectionMatrixInverse.copy(J.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Eh*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return E},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(Y){l=Y,f!==null&&(f.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(E)};let ae=null;function Re(Y,J){if(d=J.getViewerPose(c||s),x=J,d!==null){const pe=d.views;p!==null&&(e.setRenderTargetFramebuffer(g,p.framebuffer),e.setRenderTarget(g));let le=!1;pe.length!==E.cameras.length&&(E.cameras.length=0,le=!0);for(let be=0;be<pe.length;be++){const We=pe[be];let vt=null;if(p!==null)vt=p.getViewport(We);else{const U=h.getViewSubImage(f,We);vt=U.viewport,be===0&&(e.setRenderTargetTextures(g,U.colorTexture,U.depthStencilTexture),e.setRenderTarget(g))}let Ke=T[be];Ke===void 0&&(Ke=new wn,Ke.layers.enable(be),Ke.viewport=new Dt,T[be]=Ke),Ke.matrix.fromArray(We.transform.matrix),Ke.matrix.decompose(Ke.position,Ke.quaternion,Ke.scale),Ke.projectionMatrix.fromArray(We.projectionMatrix),Ke.projectionMatrixInverse.copy(Ke.projectionMatrix).invert(),Ke.viewport.set(vt.x,vt.y,vt.width,vt.height),be===0&&(E.matrix.copy(Ke.matrix),E.matrix.decompose(E.position,E.quaternion,E.scale)),le===!0&&E.cameras.push(Ke)}const ye=a.enabledFeatures;if(ye&&ye.includes("depth-sensing")&&a.depthUsage=="gpu-optimized"&&h){const be=h.getDepthInformation(pe[0]);be&&be.isValid&&be.texture&&S.init(e,be,a.renderState)}}for(let pe=0;pe<_.length;pe++){const le=y[pe],ye=_[pe];le!==null&&ye!==void 0&&ye.update(le,J,c||s)}ae&&ae(Y,J),J.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:J}),x=null}const Ve=new Sy;Ve.setAnimationLoop(Re),this.setAnimationLoop=function(Y){ae=Y},this.dispose=function(){}}}const Va=new gi,y3=new Ut;function S3(t,e){function n(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function i(m,u){u.color.getRGB(m.fogColor.value,dy(t)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function a(m,u,g,_,y){u.isMeshBasicMaterial||u.isMeshLambertMaterial?r(m,u):u.isMeshToonMaterial?(r(m,u),h(m,u)):u.isMeshPhongMaterial?(r(m,u),d(m,u)):u.isMeshStandardMaterial?(r(m,u),f(m,u),u.isMeshPhysicalMaterial&&p(m,u,y)):u.isMeshMatcapMaterial?(r(m,u),x(m,u)):u.isMeshDepthMaterial?r(m,u):u.isMeshDistanceMaterial?(r(m,u),S(m,u)):u.isMeshNormalMaterial?r(m,u):u.isLineBasicMaterial?(s(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?l(m,u,g,_):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function r(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,n(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===gn&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,n(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===gn&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,n(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,n(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,n(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const g=e.get(u),_=g.envMap,y=g.envMapRotation;_&&(m.envMap.value=_,Va.copy(y),Va.x*=-1,Va.y*=-1,Va.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Va.y*=-1,Va.z*=-1),m.envMapRotation.value.setFromMatrix4(y3.makeRotationFromEuler(Va)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,n(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,n(u.aoMap,m.aoMapTransform))}function s(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,g,_){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*g,m.scale.value=_*.5,u.map&&(m.map.value=u.map,n(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function h(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function f(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,n(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,n(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,g){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,n(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,n(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,n(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,n(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,n(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===gn&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,n(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,n(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,n(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,n(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,n(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,n(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,n(u.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,u){u.matcap&&(m.matcap.value=u.matcap)}function S(m,u){const g=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:a}}function M3(t,e,n,i){let a={},r={},s=[];const o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,_){const y=_.program;i.uniformBlockBinding(g,y)}function c(g,_){let y=a[g.id];y===void 0&&(x(g),y=d(g),a[g.id]=y,g.addEventListener("dispose",m));const R=_.program;i.updateUBOMapping(g,R);const A=e.render.frame;r[g.id]!==A&&(f(g),r[g.id]=A)}function d(g){const _=h();g.__bindingPointIndex=_;const y=t.createBuffer(),R=g.__size,A=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,R,A),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,y),y}function h(){for(let g=0;g<o;g++)if(s.indexOf(g)===-1)return s.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(g){const _=a[g.id],y=g.uniforms,R=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let A=0,w=y.length;A<w;A++){const N=Array.isArray(y[A])?y[A]:[y[A]];for(let T=0,E=N.length;T<E;T++){const L=N[T];if(p(L,A,T,R)===!0){const z=L.__offset,B=Array.isArray(L.value)?L.value:[L.value];let I=0;for(let Q=0;Q<B.length;Q++){const O=B[Q],V=S(O);typeof O=="number"||typeof O=="boolean"?(L.__data[0]=O,t.bufferSubData(t.UNIFORM_BUFFER,z+I,L.__data)):O.isMatrix3?(L.__data[0]=O.elements[0],L.__data[1]=O.elements[1],L.__data[2]=O.elements[2],L.__data[3]=0,L.__data[4]=O.elements[3],L.__data[5]=O.elements[4],L.__data[6]=O.elements[5],L.__data[7]=0,L.__data[8]=O.elements[6],L.__data[9]=O.elements[7],L.__data[10]=O.elements[8],L.__data[11]=0):(O.toArray(L.__data,I),I+=V.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,z,L.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(g,_,y,R){const A=g.value,w=_+"_"+y;if(R[w]===void 0)return typeof A=="number"||typeof A=="boolean"?R[w]=A:R[w]=A.clone(),!0;{const N=R[w];if(typeof A=="number"||typeof A=="boolean"){if(N!==A)return R[w]=A,!0}else if(N.equals(A)===!1)return N.copy(A),!0}return!1}function x(g){const _=g.uniforms;let y=0;const R=16;for(let w=0,N=_.length;w<N;w++){const T=Array.isArray(_[w])?_[w]:[_[w]];for(let E=0,L=T.length;E<L;E++){const z=T[E],B=Array.isArray(z.value)?z.value:[z.value];for(let I=0,Q=B.length;I<Q;I++){const O=B[I],V=S(O),D=y%R,q=D%V.boundary,Z=D+q;y+=q,Z!==0&&R-Z<V.storage&&(y+=R-Z),z.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=y,y+=V.storage}}}const A=y%R;return A>0&&(y+=R-A),g.__size=y,g.__cache={},this}function S(g){const _={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(_.boundary=4,_.storage=4):g.isVector2?(_.boundary=8,_.storage=8):g.isVector3||g.isColor?(_.boundary=16,_.storage=12):g.isVector4?(_.boundary=16,_.storage=16):g.isMatrix3?(_.boundary=48,_.storage=48):g.isMatrix4?(_.boundary=64,_.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),_}function m(g){const _=g.target;_.removeEventListener("dispose",m);const y=s.indexOf(_.__bindingPointIndex);s.splice(y,1),t.deleteBuffer(a[_.id]),delete a[_.id],delete r[_.id]}function u(){for(const g in a)t.deleteBuffer(a[g]);s=[],a={},r={}}return{bind:l,update:c,dispose:u}}class Ay{constructor(e={}){const{canvas:n=aA(),context:i=null,depth:a=!0,stencil:r=!1,alpha:s=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=s;const x=new Uint32Array(4),S=new Int32Array(4);let m=null,u=null;const g=[],_=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Aa,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let R=!1;this._outputColorSpace=In;let A=0,w=0,N=null,T=-1,E=null;const L=new Dt,z=new Dt;let B=null;const I=new $e(0);let Q=0,O=n.width,V=n.height,D=1,q=null,Z=null;const ae=new Dt(0,0,O,V),Re=new Dt(0,0,O,V);let Ve=!1;const Y=new kp;let J=!1,pe=!1;const le=new Ut,ye=new Ut,Me=new j,be=new Dt,We={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let vt=!1;function Ke(){return N===null?D:1}let U=i;function jt(b,F){return n.getContext(b,F)}try{const b={alpha:!0,depth:a,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Up}`),n.addEventListener("webglcontextlost",ve,!1),n.addEventListener("webglcontextrestored",se,!1),n.addEventListener("webglcontextcreationerror",te,!1),U===null){const F="webgl2";if(U=jt(F,b),U===null)throw jt(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Qe,mt,Ee,Je,Ce,Fe,It,C,M,k,$,ne,K,Te,fe,Se,Ae,ie,me,Ue,De,ce,ze,P;function de(){Qe=new L2(U),Qe.init(),ce=new m3(U,Qe),mt=new A2(U,Qe,e,ce),Ee=new h3(U,Qe),mt.reverseDepthBuffer&&f&&Ee.buffers.depth.setReversed(!0),Je=new z2(U),Ce=new e3,Fe=new p3(U,Qe,Ee,Ce,mt,ce,Je),It=new R2(y),C=new U2(y),M=new VA(U),ze=new b2(U,M),k=new O2(U,M,Je,ze),$=new I2(U,k,M,Je),me=new B2(U,mt,Fe),Se=new w2(Ce),ne=new JC(y,It,C,Qe,mt,ze,Se),K=new S3(y,Ce),Te=new n3,fe=new l3(Qe),ie=new E2(y,It,C,Ee,$,p,l),Ae=new f3(y,$,mt),P=new M3(U,Je,mt,Ee),Ue=new T2(U,Qe,Je),De=new P2(U,Qe,Je),Je.programs=ne.programs,y.capabilities=mt,y.extensions=Qe,y.properties=Ce,y.renderLists=Te,y.shadowMap=Ae,y.state=Ee,y.info=Je}de();const re=new x3(y,U);this.xr=re,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const b=Qe.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Qe.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return D},this.setPixelRatio=function(b){b!==void 0&&(D=b,this.setSize(O,V,!1))},this.getSize=function(b){return b.set(O,V)},this.setSize=function(b,F,X=!0){if(re.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}O=b,V=F,n.width=Math.floor(b*D),n.height=Math.floor(F*D),X===!0&&(n.style.width=b+"px",n.style.height=F+"px"),this.setViewport(0,0,b,F)},this.getDrawingBufferSize=function(b){return b.set(O*D,V*D).floor()},this.setDrawingBufferSize=function(b,F,X){O=b,V=F,D=X,n.width=Math.floor(b*X),n.height=Math.floor(F*X),this.setViewport(0,0,b,F)},this.getCurrentViewport=function(b){return b.copy(L)},this.getViewport=function(b){return b.copy(ae)},this.setViewport=function(b,F,X,W){b.isVector4?ae.set(b.x,b.y,b.z,b.w):ae.set(b,F,X,W),Ee.viewport(L.copy(ae).multiplyScalar(D).round())},this.getScissor=function(b){return b.copy(Re)},this.setScissor=function(b,F,X,W){b.isVector4?Re.set(b.x,b.y,b.z,b.w):Re.set(b,F,X,W),Ee.scissor(z.copy(Re).multiplyScalar(D).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(b){Ee.setScissorTest(Ve=b)},this.setOpaqueSort=function(b){q=b},this.setTransparentSort=function(b){Z=b},this.getClearColor=function(b){return b.copy(ie.getClearColor())},this.setClearColor=function(){ie.setClearColor(...arguments)},this.getClearAlpha=function(){return ie.getClearAlpha()},this.setClearAlpha=function(){ie.setClearAlpha(...arguments)},this.clear=function(b=!0,F=!0,X=!0){let W=0;if(b){let H=!1;if(N!==null){const oe=N.texture.format;H=oe===Hp||oe===Fp||oe===Ip}if(H){const oe=N.texture.type,he=oe===mi||oe===cr||oe===Do||oe===Uo||oe===zp||oe===Bp,xe=ie.getClearColor(),ge=ie.getClearAlpha(),Oe=xe.r,Pe=xe.g,we=xe.b;he?(x[0]=Oe,x[1]=Pe,x[2]=we,x[3]=ge,U.clearBufferuiv(U.COLOR,0,x)):(S[0]=Oe,S[1]=Pe,S[2]=we,S[3]=ge,U.clearBufferiv(U.COLOR,0,S))}else W|=U.COLOR_BUFFER_BIT}F&&(W|=U.DEPTH_BUFFER_BIT),X&&(W|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(W)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ve,!1),n.removeEventListener("webglcontextrestored",se,!1),n.removeEventListener("webglcontextcreationerror",te,!1),ie.dispose(),Te.dispose(),fe.dispose(),Ce.dispose(),It.dispose(),C.dispose(),$.dispose(),ze.dispose(),P.dispose(),ne.dispose(),re.dispose(),re.removeEventListener("sessionstart",Xp),re.removeEventListener("sessionend",Wp),Oa.stop()};function ve(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function se(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const b=Je.autoReset,F=Ae.enabled,X=Ae.autoUpdate,W=Ae.needsUpdate,H=Ae.type;de(),Je.autoReset=b,Ae.enabled=F,Ae.autoUpdate=X,Ae.needsUpdate=W,Ae.type=H}function te(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function _e(b){const F=b.target;F.removeEventListener("dispose",_e),Be(F)}function Be(b){_t(b),Ce.remove(b)}function _t(b){const F=Ce.get(b).programs;F!==void 0&&(F.forEach(function(X){ne.releaseProgram(X)}),b.isShaderMaterial&&ne.releaseShaderCache(b))}this.renderBufferDirect=function(b,F,X,W,H,oe){F===null&&(F=We);const he=H.isMesh&&H.matrixWorld.determinant()<0,xe=Ry(b,F,X,W,H);Ee.setMaterial(W,he);let ge=X.index,Oe=1;if(W.wireframe===!0){if(ge=k.getWireframeAttribute(X),ge===void 0)return;Oe=2}const Pe=X.drawRange,we=X.attributes.position;let qe=Pe.start*Oe,ct=(Pe.start+Pe.count)*Oe;oe!==null&&(qe=Math.max(qe,oe.start*Oe),ct=Math.min(ct,(oe.start+oe.count)*Oe)),ge!==null?(qe=Math.max(qe,0),ct=Math.min(ct,ge.count)):we!=null&&(qe=Math.max(qe,0),ct=Math.min(ct,we.count));const Rt=ct-qe;if(Rt<0||Rt===1/0)return;ze.setup(H,W,xe,X,ge);let xt,ht=Ue;if(ge!==null&&(xt=M.get(ge),ht=De,ht.setIndex(xt)),H.isMesh)W.wireframe===!0?(Ee.setLineWidth(W.wireframeLinewidth*Ke()),ht.setMode(U.LINES)):ht.setMode(U.TRIANGLES);else if(H.isLine){let Ne=W.linewidth;Ne===void 0&&(Ne=1),Ee.setLineWidth(Ne*Ke()),H.isLineSegments?ht.setMode(U.LINES):H.isLineLoop?ht.setMode(U.LINE_LOOP):ht.setMode(U.LINE_STRIP)}else H.isPoints?ht.setMode(U.POINTS):H.isSprite&&ht.setMode(U.TRIANGLES);if(H.isBatchedMesh)if(H._multiDrawInstances!==null)rs("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ht.renderMultiDrawInstances(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount,H._multiDrawInstances);else if(Qe.get("WEBGL_multi_draw"))ht.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const Ne=H._multiDrawStarts,Tt=H._multiDrawCounts,et=H._multiDrawCount,yn=ge?M.get(ge).bytesPerElement:1,gr=Ce.get(W).currentProgram.getUniforms();for(let Sn=0;Sn<et;Sn++)gr.setValue(U,"_gl_DrawID",Sn),ht.render(Ne[Sn]/yn,Tt[Sn])}else if(H.isInstancedMesh)ht.renderInstances(qe,Rt,H.count);else if(X.isInstancedBufferGeometry){const Ne=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,Tt=Math.min(X.instanceCount,Ne);ht.renderInstances(qe,Rt,Tt)}else ht.render(qe,Rt)};function st(b,F,X){b.transparent===!0&&b.side===$n&&b.forceSinglePass===!1?(b.side=gn,b.needsUpdate=!0,ol(b,F,X),b.side=Na,b.needsUpdate=!0,ol(b,F,X),b.side=$n):ol(b,F,X)}this.compile=function(b,F,X=null){X===null&&(X=b),u=fe.get(X),u.init(F),_.push(u),X.traverseVisible(function(H){H.isLight&&H.layers.test(F.layers)&&(u.pushLight(H),H.castShadow&&u.pushShadow(H))}),b!==X&&b.traverseVisible(function(H){H.isLight&&H.layers.test(F.layers)&&(u.pushLight(H),H.castShadow&&u.pushShadow(H))}),u.setupLights();const W=new Set;return b.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const oe=H.material;if(oe)if(Array.isArray(oe))for(let he=0;he<oe.length;he++){const xe=oe[he];st(xe,X,H),W.add(xe)}else st(oe,X,H),W.add(oe)}),u=_.pop(),W},this.compileAsync=function(b,F,X=null){const W=this.compile(b,F,X);return new Promise(H=>{function oe(){if(W.forEach(function(he){Ce.get(he).currentProgram.isReady()&&W.delete(he)}),W.size===0){H(b);return}setTimeout(oe,10)}Qe.get("KHR_parallel_shader_compile")!==null?oe():setTimeout(oe,10)})};let qn=null;function yi(b){qn&&qn(b)}function Xp(){Oa.stop()}function Wp(){Oa.start()}const Oa=new Sy;Oa.setAnimationLoop(yi),typeof self<"u"&&Oa.setContext(self),this.setAnimationLoop=function(b){qn=b,re.setAnimationLoop(b),b===null?Oa.stop():Oa.start()},re.addEventListener("sessionstart",Xp),re.addEventListener("sessionend",Wp),this.render=function(b,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),re.enabled===!0&&re.isPresenting===!0&&(re.cameraAutoUpdate===!0&&re.updateCamera(F),F=re.getCamera()),b.isScene===!0&&b.onBeforeRender(y,b,F,N),u=fe.get(b,_.length),u.init(F),_.push(u),ye.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Y.setFromProjectionMatrix(ye),pe=this.localClippingEnabled,J=Se.init(this.clippingPlanes,pe),m=Te.get(b,g.length),m.init(),g.push(m),re.enabled===!0&&re.isPresenting===!0){const oe=y.xr.getDepthSensingMesh();oe!==null&&yu(oe,F,-1/0,y.sortObjects)}yu(b,F,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(q,Z),vt=re.enabled===!1||re.isPresenting===!1||re.hasDepthSensing()===!1,vt&&ie.addToRenderList(m,b),this.info.render.frame++,J===!0&&Se.beginShadows();const X=u.state.shadowsArray;Ae.render(X,b,F),J===!0&&Se.endShadows(),this.info.autoReset===!0&&this.info.reset();const W=m.opaque,H=m.transmissive;if(u.setupLights(),F.isArrayCamera){const oe=F.cameras;if(H.length>0)for(let he=0,xe=oe.length;he<xe;he++){const ge=oe[he];Yp(W,H,b,ge)}vt&&ie.render(b);for(let he=0,xe=oe.length;he<xe;he++){const ge=oe[he];qp(m,b,ge,ge.viewport)}}else H.length>0&&Yp(W,H,b,F),vt&&ie.render(b),qp(m,b,F);N!==null&&w===0&&(Fe.updateMultisampleRenderTarget(N),Fe.updateRenderTargetMipmap(N)),b.isScene===!0&&b.onAfterRender(y,b,F),ze.resetDefaultState(),T=-1,E=null,_.pop(),_.length>0?(u=_[_.length-1],J===!0&&Se.setGlobalState(y.clippingPlanes,u.state.camera)):u=null,g.pop(),g.length>0?m=g[g.length-1]:m=null};function yu(b,F,X,W){if(b.visible===!1)return;if(b.layers.test(F.layers)){if(b.isGroup)X=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(F);else if(b.isLight)u.pushLight(b),b.castShadow&&u.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||Y.intersectsSprite(b)){W&&be.setFromMatrixPosition(b.matrixWorld).applyMatrix4(ye);const he=$.update(b),xe=b.material;xe.visible&&m.push(b,he,xe,X,be.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||Y.intersectsObject(b))){const he=$.update(b),xe=b.material;if(W&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),be.copy(b.boundingSphere.center)):(he.boundingSphere===null&&he.computeBoundingSphere(),be.copy(he.boundingSphere.center)),be.applyMatrix4(b.matrixWorld).applyMatrix4(ye)),Array.isArray(xe)){const ge=he.groups;for(let Oe=0,Pe=ge.length;Oe<Pe;Oe++){const we=ge[Oe],qe=xe[we.materialIndex];qe&&qe.visible&&m.push(b,he,qe,X,be.z,we)}}else xe.visible&&m.push(b,he,xe,X,be.z,null)}}const oe=b.children;for(let he=0,xe=oe.length;he<xe;he++)yu(oe[he],F,X,W)}function qp(b,F,X,W){const H=b.opaque,oe=b.transmissive,he=b.transparent;u.setupLightsView(X),J===!0&&Se.setGlobalState(y.clippingPlanes,X),W&&Ee.viewport(L.copy(W)),H.length>0&&sl(H,F,X),oe.length>0&&sl(oe,F,X),he.length>0&&sl(he,F,X),Ee.buffers.depth.setTest(!0),Ee.buffers.depth.setMask(!0),Ee.buffers.color.setMask(!0),Ee.setPolygonOffset(!1)}function Yp(b,F,X,W){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[W.id]===void 0&&(u.state.transmissionRenderTarget[W.id]=new ur(1,1,{generateMipmaps:!0,type:Qe.has("EXT_color_buffer_half_float")||Qe.has("EXT_color_buffer_float")?el:mi,minFilter:Qa,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:tt.workingColorSpace}));const oe=u.state.transmissionRenderTarget[W.id],he=W.viewport||L;oe.setSize(he.z*y.transmissionResolutionScale,he.w*y.transmissionResolutionScale);const xe=y.getRenderTarget(),ge=y.getActiveCubeFace(),Oe=y.getActiveMipmapLevel();y.setRenderTarget(oe),y.getClearColor(I),Q=y.getClearAlpha(),Q<1&&y.setClearColor(16777215,.5),y.clear(),vt&&ie.render(X);const Pe=y.toneMapping;y.toneMapping=Aa;const we=W.viewport;if(W.viewport!==void 0&&(W.viewport=void 0),u.setupLightsView(W),J===!0&&Se.setGlobalState(y.clippingPlanes,W),sl(b,X,W),Fe.updateMultisampleRenderTarget(oe),Fe.updateRenderTargetMipmap(oe),Qe.has("WEBGL_multisampled_render_to_texture")===!1){let qe=!1;for(let ct=0,Rt=F.length;ct<Rt;ct++){const xt=F[ct],ht=xt.object,Ne=xt.geometry,Tt=xt.material,et=xt.group;if(Tt.side===$n&&ht.layers.test(W.layers)){const yn=Tt.side;Tt.side=gn,Tt.needsUpdate=!0,Zp(ht,X,W,Ne,Tt,et),Tt.side=yn,Tt.needsUpdate=!0,qe=!0}}qe===!0&&(Fe.updateMultisampleRenderTarget(oe),Fe.updateRenderTargetMipmap(oe))}y.setRenderTarget(xe,ge,Oe),y.setClearColor(I,Q),we!==void 0&&(W.viewport=we),y.toneMapping=Pe}function sl(b,F,X){const W=F.isScene===!0?F.overrideMaterial:null;for(let H=0,oe=b.length;H<oe;H++){const he=b[H],xe=he.object,ge=he.geometry,Oe=he.group;let Pe=he.material;Pe.allowOverride===!0&&W!==null&&(Pe=W),xe.layers.test(X.layers)&&Zp(xe,F,X,ge,Pe,Oe)}}function Zp(b,F,X,W,H,oe){b.onBeforeRender(y,F,X,W,H,oe),b.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),H.onBeforeRender(y,F,X,W,b,oe),H.transparent===!0&&H.side===$n&&H.forceSinglePass===!1?(H.side=gn,H.needsUpdate=!0,y.renderBufferDirect(X,F,W,H,b,oe),H.side=Na,H.needsUpdate=!0,y.renderBufferDirect(X,F,W,H,b,oe),H.side=$n):y.renderBufferDirect(X,F,W,H,b,oe),b.onAfterRender(y,F,X,W,H,oe)}function ol(b,F,X){F.isScene!==!0&&(F=We);const W=Ce.get(b),H=u.state.lights,oe=u.state.shadowsArray,he=H.state.version,xe=ne.getParameters(b,H.state,oe,F,X),ge=ne.getProgramCacheKey(xe);let Oe=W.programs;W.environment=b.isMeshStandardMaterial?F.environment:null,W.fog=F.fog,W.envMap=(b.isMeshStandardMaterial?C:It).get(b.envMap||W.environment),W.envMapRotation=W.environment!==null&&b.envMap===null?F.environmentRotation:b.envMapRotation,Oe===void 0&&(b.addEventListener("dispose",_e),Oe=new Map,W.programs=Oe);let Pe=Oe.get(ge);if(Pe!==void 0){if(W.currentProgram===Pe&&W.lightsStateVersion===he)return Qp(b,xe),Pe}else xe.uniforms=ne.getUniforms(b),b.onBeforeCompile(xe,y),Pe=ne.acquireProgram(xe,ge),Oe.set(ge,Pe),W.uniforms=xe.uniforms;const we=W.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(we.clippingPlanes=Se.uniform),Qp(b,xe),W.needsLights=Ny(b),W.lightsStateVersion=he,W.needsLights&&(we.ambientLightColor.value=H.state.ambient,we.lightProbe.value=H.state.probe,we.directionalLights.value=H.state.directional,we.directionalLightShadows.value=H.state.directionalShadow,we.spotLights.value=H.state.spot,we.spotLightShadows.value=H.state.spotShadow,we.rectAreaLights.value=H.state.rectArea,we.ltc_1.value=H.state.rectAreaLTC1,we.ltc_2.value=H.state.rectAreaLTC2,we.pointLights.value=H.state.point,we.pointLightShadows.value=H.state.pointShadow,we.hemisphereLights.value=H.state.hemi,we.directionalShadowMap.value=H.state.directionalShadowMap,we.directionalShadowMatrix.value=H.state.directionalShadowMatrix,we.spotShadowMap.value=H.state.spotShadowMap,we.spotLightMatrix.value=H.state.spotLightMatrix,we.spotLightMap.value=H.state.spotLightMap,we.pointShadowMap.value=H.state.pointShadowMap,we.pointShadowMatrix.value=H.state.pointShadowMatrix),W.currentProgram=Pe,W.uniformsList=null,Pe}function Kp(b){if(b.uniformsList===null){const F=b.currentProgram.getUniforms();b.uniformsList=dc.seqWithValue(F.seq,b.uniforms)}return b.uniformsList}function Qp(b,F){const X=Ce.get(b);X.outputColorSpace=F.outputColorSpace,X.batching=F.batching,X.batchingColor=F.batchingColor,X.instancing=F.instancing,X.instancingColor=F.instancingColor,X.instancingMorph=F.instancingMorph,X.skinning=F.skinning,X.morphTargets=F.morphTargets,X.morphNormals=F.morphNormals,X.morphColors=F.morphColors,X.morphTargetsCount=F.morphTargetsCount,X.numClippingPlanes=F.numClippingPlanes,X.numIntersection=F.numClipIntersection,X.vertexAlphas=F.vertexAlphas,X.vertexTangents=F.vertexTangents,X.toneMapping=F.toneMapping}function Ry(b,F,X,W,H){F.isScene!==!0&&(F=We),Fe.resetTextureUnits();const oe=F.fog,he=W.isMeshStandardMaterial?F.environment:null,xe=N===null?y.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Ss,ge=(W.isMeshStandardMaterial?C:It).get(W.envMap||he),Oe=W.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,Pe=!!X.attributes.tangent&&(!!W.normalMap||W.anisotropy>0),we=!!X.morphAttributes.position,qe=!!X.morphAttributes.normal,ct=!!X.morphAttributes.color;let Rt=Aa;W.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(Rt=y.toneMapping);const xt=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,ht=xt!==void 0?xt.length:0,Ne=Ce.get(W),Tt=u.state.lights;if(J===!0&&(pe===!0||b!==E)){const rn=b===E&&W.id===T;Se.setState(W,b,rn)}let et=!1;W.version===Ne.__version?(Ne.needsLights&&Ne.lightsStateVersion!==Tt.state.version||Ne.outputColorSpace!==xe||H.isBatchedMesh&&Ne.batching===!1||!H.isBatchedMesh&&Ne.batching===!0||H.isBatchedMesh&&Ne.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&Ne.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&Ne.instancing===!1||!H.isInstancedMesh&&Ne.instancing===!0||H.isSkinnedMesh&&Ne.skinning===!1||!H.isSkinnedMesh&&Ne.skinning===!0||H.isInstancedMesh&&Ne.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Ne.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&Ne.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&Ne.instancingMorph===!1&&H.morphTexture!==null||Ne.envMap!==ge||W.fog===!0&&Ne.fog!==oe||Ne.numClippingPlanes!==void 0&&(Ne.numClippingPlanes!==Se.numPlanes||Ne.numIntersection!==Se.numIntersection)||Ne.vertexAlphas!==Oe||Ne.vertexTangents!==Pe||Ne.morphTargets!==we||Ne.morphNormals!==qe||Ne.morphColors!==ct||Ne.toneMapping!==Rt||Ne.morphTargetsCount!==ht)&&(et=!0):(et=!0,Ne.__version=W.version);let yn=Ne.currentProgram;et===!0&&(yn=ol(W,F,H));let gr=!1,Sn=!1,Os=!1;const St=yn.getUniforms(),On=Ne.uniforms;if(Ee.useProgram(yn.program)&&(gr=!0,Sn=!0,Os=!0),W.id!==T&&(T=W.id,Sn=!0),gr||E!==b){Ee.buffers.depth.getReversed()?(le.copy(b.projectionMatrix),sA(le),oA(le),St.setValue(U,"projectionMatrix",le)):St.setValue(U,"projectionMatrix",b.projectionMatrix),St.setValue(U,"viewMatrix",b.matrixWorldInverse);const un=St.map.cameraPosition;un!==void 0&&un.setValue(U,Me.setFromMatrixPosition(b.matrixWorld)),mt.logarithmicDepthBuffer&&St.setValue(U,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(W.isMeshPhongMaterial||W.isMeshToonMaterial||W.isMeshLambertMaterial||W.isMeshBasicMaterial||W.isMeshStandardMaterial||W.isShaderMaterial)&&St.setValue(U,"isOrthographic",b.isOrthographicCamera===!0),E!==b&&(E=b,Sn=!0,Os=!0)}if(H.isSkinnedMesh){St.setOptional(U,H,"bindMatrix"),St.setOptional(U,H,"bindMatrixInverse");const rn=H.skeleton;rn&&(rn.boneTexture===null&&rn.computeBoneTexture(),St.setValue(U,"boneTexture",rn.boneTexture,Fe))}H.isBatchedMesh&&(St.setOptional(U,H,"batchingTexture"),St.setValue(U,"batchingTexture",H._matricesTexture,Fe),St.setOptional(U,H,"batchingIdTexture"),St.setValue(U,"batchingIdTexture",H._indirectTexture,Fe),St.setOptional(U,H,"batchingColorTexture"),H._colorsTexture!==null&&St.setValue(U,"batchingColorTexture",H._colorsTexture,Fe));const Pn=X.morphAttributes;if((Pn.position!==void 0||Pn.normal!==void 0||Pn.color!==void 0)&&me.update(H,X,yn),(Sn||Ne.receiveShadow!==H.receiveShadow)&&(Ne.receiveShadow=H.receiveShadow,St.setValue(U,"receiveShadow",H.receiveShadow)),W.isMeshGouraudMaterial&&W.envMap!==null&&(On.envMap.value=ge,On.flipEnvMap.value=ge.isCubeTexture&&ge.isRenderTargetTexture===!1?-1:1),W.isMeshStandardMaterial&&W.envMap===null&&F.environment!==null&&(On.envMapIntensity.value=F.environmentIntensity),Sn&&(St.setValue(U,"toneMappingExposure",y.toneMappingExposure),Ne.needsLights&&Cy(On,Os),oe&&W.fog===!0&&K.refreshFogUniforms(On,oe),K.refreshMaterialUniforms(On,W,D,V,u.state.transmissionRenderTarget[b.id]),dc.upload(U,Kp(Ne),On,Fe)),W.isShaderMaterial&&W.uniformsNeedUpdate===!0&&(dc.upload(U,Kp(Ne),On,Fe),W.uniformsNeedUpdate=!1),W.isSpriteMaterial&&St.setValue(U,"center",H.center),St.setValue(U,"modelViewMatrix",H.modelViewMatrix),St.setValue(U,"normalMatrix",H.normalMatrix),St.setValue(U,"modelMatrix",H.matrixWorld),W.isShaderMaterial||W.isRawShaderMaterial){const rn=W.uniformsGroups;for(let un=0,Su=rn.length;un<Su;un++){const Pa=rn[un];P.update(Pa,yn),P.bind(Pa,yn)}}return yn}function Cy(b,F){b.ambientLightColor.needsUpdate=F,b.lightProbe.needsUpdate=F,b.directionalLights.needsUpdate=F,b.directionalLightShadows.needsUpdate=F,b.pointLights.needsUpdate=F,b.pointLightShadows.needsUpdate=F,b.spotLights.needsUpdate=F,b.spotLightShadows.needsUpdate=F,b.rectAreaLights.needsUpdate=F,b.hemisphereLights.needsUpdate=F}function Ny(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(b,F,X){const W=Ce.get(b);W.__autoAllocateDepthBuffer=b.resolveDepthBuffer===!1,W.__autoAllocateDepthBuffer===!1&&(W.__useRenderToTexture=!1),Ce.get(b.texture).__webglTexture=F,Ce.get(b.depthTexture).__webglTexture=W.__autoAllocateDepthBuffer?void 0:X,W.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(b,F){const X=Ce.get(b);X.__webglFramebuffer=F,X.__useDefaultFramebuffer=F===void 0};const Dy=U.createFramebuffer();this.setRenderTarget=function(b,F=0,X=0){N=b,A=F,w=X;let W=!0,H=null,oe=!1,he=!1;if(b){const ge=Ce.get(b);if(ge.__useDefaultFramebuffer!==void 0)Ee.bindFramebuffer(U.FRAMEBUFFER,null),W=!1;else if(ge.__webglFramebuffer===void 0)Fe.setupRenderTarget(b);else if(ge.__hasExternalTextures)Fe.rebindTextures(b,Ce.get(b.texture).__webglTexture,Ce.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const we=b.depthTexture;if(ge.__boundDepthTexture!==we){if(we!==null&&Ce.has(we)&&(b.width!==we.image.width||b.height!==we.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Fe.setupDepthRenderbuffer(b)}}const Oe=b.texture;(Oe.isData3DTexture||Oe.isDataArrayTexture||Oe.isCompressedArrayTexture)&&(he=!0);const Pe=Ce.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Pe[F])?H=Pe[F][X]:H=Pe[F],oe=!0):b.samples>0&&Fe.useMultisampledRTT(b)===!1?H=Ce.get(b).__webglMultisampledFramebuffer:Array.isArray(Pe)?H=Pe[X]:H=Pe,L.copy(b.viewport),z.copy(b.scissor),B=b.scissorTest}else L.copy(ae).multiplyScalar(D).floor(),z.copy(Re).multiplyScalar(D).floor(),B=Ve;if(X!==0&&(H=Dy),Ee.bindFramebuffer(U.FRAMEBUFFER,H)&&W&&Ee.drawBuffers(b,H),Ee.viewport(L),Ee.scissor(z),Ee.setScissorTest(B),oe){const ge=Ce.get(b.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+F,ge.__webglTexture,X)}else if(he){const ge=Ce.get(b.texture),Oe=F;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,ge.__webglTexture,X,Oe)}else if(b!==null&&X!==0){const ge=Ce.get(b.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,ge.__webglTexture,X)}T=-1},this.readRenderTargetPixels=function(b,F,X,W,H,oe,he,xe=0){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ge=Ce.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&he!==void 0&&(ge=ge[he]),ge){Ee.bindFramebuffer(U.FRAMEBUFFER,ge);try{const Oe=b.textures[xe],Pe=Oe.format,we=Oe.type;if(!mt.textureFormatReadable(Pe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!mt.textureTypeReadable(we)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=b.width-W&&X>=0&&X<=b.height-H&&(b.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+xe),U.readPixels(F,X,W,H,ce.convert(Pe),ce.convert(we),oe))}finally{const Oe=N!==null?Ce.get(N).__webglFramebuffer:null;Ee.bindFramebuffer(U.FRAMEBUFFER,Oe)}}},this.readRenderTargetPixelsAsync=async function(b,F,X,W,H,oe,he,xe=0){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ge=Ce.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&he!==void 0&&(ge=ge[he]),ge)if(F>=0&&F<=b.width-W&&X>=0&&X<=b.height-H){Ee.bindFramebuffer(U.FRAMEBUFFER,ge);const Oe=b.textures[xe],Pe=Oe.format,we=Oe.type;if(!mt.textureFormatReadable(Pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!mt.textureTypeReadable(we))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const qe=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,qe),U.bufferData(U.PIXEL_PACK_BUFFER,oe.byteLength,U.STREAM_READ),b.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+xe),U.readPixels(F,X,W,H,ce.convert(Pe),ce.convert(we),0);const ct=N!==null?Ce.get(N).__webglFramebuffer:null;Ee.bindFramebuffer(U.FRAMEBUFFER,ct);const Rt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await rA(U,Rt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,qe),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,oe),U.deleteBuffer(qe),U.deleteSync(Rt),oe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(b,F=null,X=0){const W=Math.pow(2,-X),H=Math.floor(b.image.width*W),oe=Math.floor(b.image.height*W),he=F!==null?F.x:0,xe=F!==null?F.y:0;Fe.setTexture2D(b,0),U.copyTexSubImage2D(U.TEXTURE_2D,X,0,0,he,xe,H,oe),Ee.unbindTexture()};const Uy=U.createFramebuffer(),Ly=U.createFramebuffer();this.copyTextureToTexture=function(b,F,X=null,W=null,H=0,oe=null){oe===null&&(H!==0?(rs("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),oe=H,H=0):oe=0);let he,xe,ge,Oe,Pe,we,qe,ct,Rt;const xt=b.isCompressedTexture?b.mipmaps[oe]:b.image;if(X!==null)he=X.max.x-X.min.x,xe=X.max.y-X.min.y,ge=X.isBox3?X.max.z-X.min.z:1,Oe=X.min.x,Pe=X.min.y,we=X.isBox3?X.min.z:0;else{const Pn=Math.pow(2,-H);he=Math.floor(xt.width*Pn),xe=Math.floor(xt.height*Pn),b.isDataArrayTexture?ge=xt.depth:b.isData3DTexture?ge=Math.floor(xt.depth*Pn):ge=1,Oe=0,Pe=0,we=0}W!==null?(qe=W.x,ct=W.y,Rt=W.z):(qe=0,ct=0,Rt=0);const ht=ce.convert(F.format),Ne=ce.convert(F.type);let Tt;F.isData3DTexture?(Fe.setTexture3D(F,0),Tt=U.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(Fe.setTexture2DArray(F,0),Tt=U.TEXTURE_2D_ARRAY):(Fe.setTexture2D(F,0),Tt=U.TEXTURE_2D),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,F.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,F.unpackAlignment);const et=U.getParameter(U.UNPACK_ROW_LENGTH),yn=U.getParameter(U.UNPACK_IMAGE_HEIGHT),gr=U.getParameter(U.UNPACK_SKIP_PIXELS),Sn=U.getParameter(U.UNPACK_SKIP_ROWS),Os=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,xt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,xt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Oe),U.pixelStorei(U.UNPACK_SKIP_ROWS,Pe),U.pixelStorei(U.UNPACK_SKIP_IMAGES,we);const St=b.isDataArrayTexture||b.isData3DTexture,On=F.isDataArrayTexture||F.isData3DTexture;if(b.isDepthTexture){const Pn=Ce.get(b),rn=Ce.get(F),un=Ce.get(Pn.__renderTarget),Su=Ce.get(rn.__renderTarget);Ee.bindFramebuffer(U.READ_FRAMEBUFFER,un.__webglFramebuffer),Ee.bindFramebuffer(U.DRAW_FRAMEBUFFER,Su.__webglFramebuffer);for(let Pa=0;Pa<ge;Pa++)St&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ce.get(b).__webglTexture,H,we+Pa),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ce.get(F).__webglTexture,oe,Rt+Pa)),U.blitFramebuffer(Oe,Pe,he,xe,qe,ct,he,xe,U.DEPTH_BUFFER_BIT,U.NEAREST);Ee.bindFramebuffer(U.READ_FRAMEBUFFER,null),Ee.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(H!==0||b.isRenderTargetTexture||Ce.has(b)){const Pn=Ce.get(b),rn=Ce.get(F);Ee.bindFramebuffer(U.READ_FRAMEBUFFER,Uy),Ee.bindFramebuffer(U.DRAW_FRAMEBUFFER,Ly);for(let un=0;un<ge;un++)St?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Pn.__webglTexture,H,we+un):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Pn.__webglTexture,H),On?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,rn.__webglTexture,oe,Rt+un):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,rn.__webglTexture,oe),H!==0?U.blitFramebuffer(Oe,Pe,he,xe,qe,ct,he,xe,U.COLOR_BUFFER_BIT,U.NEAREST):On?U.copyTexSubImage3D(Tt,oe,qe,ct,Rt+un,Oe,Pe,he,xe):U.copyTexSubImage2D(Tt,oe,qe,ct,Oe,Pe,he,xe);Ee.bindFramebuffer(U.READ_FRAMEBUFFER,null),Ee.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else On?b.isDataTexture||b.isData3DTexture?U.texSubImage3D(Tt,oe,qe,ct,Rt,he,xe,ge,ht,Ne,xt.data):F.isCompressedArrayTexture?U.compressedTexSubImage3D(Tt,oe,qe,ct,Rt,he,xe,ge,ht,xt.data):U.texSubImage3D(Tt,oe,qe,ct,Rt,he,xe,ge,ht,Ne,xt):b.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,oe,qe,ct,he,xe,ht,Ne,xt.data):b.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,oe,qe,ct,xt.width,xt.height,ht,xt.data):U.texSubImage2D(U.TEXTURE_2D,oe,qe,ct,he,xe,ht,Ne,xt);U.pixelStorei(U.UNPACK_ROW_LENGTH,et),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,yn),U.pixelStorei(U.UNPACK_SKIP_PIXELS,gr),U.pixelStorei(U.UNPACK_SKIP_ROWS,Sn),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Os),oe===0&&F.generateMipmaps&&U.generateMipmap(Tt),Ee.unbindTexture()},this.copyTextureToTexture3D=function(b,F,X=null,W=null,H=0){return rs('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(b,F,X,W,H)},this.initRenderTarget=function(b){Ce.get(b).__webglFramebuffer===void 0&&Fe.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?Fe.setTextureCube(b,0):b.isData3DTexture?Fe.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?Fe.setTexture2DArray(b,0):Fe.setTexture2D(b,0),Ee.unbindTexture()},this.resetState=function(){A=0,w=0,N=null,Ee.reset(),ze.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Bi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=tt._getDrawingBufferColorSpace(e),n.unpackColorSpace=tt._getUnpackColorSpace()}}function wy({model:t,onClose:e}){var L;const n=G.useRef(null),i=G.useRef(null),a=G.useRef(null),r=G.useRef(null),s=G.useRef(null),o=G.useRef(null),l=G.useRef(null),c=G.useRef(null),[d,h]=G.useState(!1),[f,p]=G.useState(!0),[x,S]=G.useState(null),[m,u]=G.useState(!0),[g,_]=G.useState(!1),y=z=>{if(!z||!z.id||!z.processor)return null;const B=z.processor;let I=null;return z.objFiles&&z.objFiles.length>0?I=z.objFiles[0].filename:B==="open3d"||B==="meshroom"?I="texturedMesh.obj":I=z.fileName||`${z.name}.obj`,`http://localhost:3001/models/${B}/${z.id}/${I}`};G.useEffect(()=>{if(!n.current)return;const z=new my;z.background=new $e(15790320),i.current=z;const B=new wn(75,n.current.clientWidth/n.current.clientHeight,.1,1e3);r.current=B;const I=new Ay({antialias:!0});I.setSize(n.current.clientWidth,n.current.clientHeight),I.shadowMap.enabled=!0,I.shadowMap.type=Lp,a.current=I,n.current.appendChild(I.domElement);const Q=new yy(4210752,.6);z.add(Q);const O=new Yc(16777215,.8);O.position.set(10,10,5),O.castShadow=!0,z.add(O);const V=new Yc(16777215,.4);V.position.set(-10,-10,-5),z.add(V);const D={isMouseDown:!1,previousMousePosition:{x:0,y:0},rotation:{x:0,y:0},zoom:1,pan:{x:0,y:0}};s.current=D;const q=J=>{D.isMouseDown=!0,D.previousMousePosition={x:J.clientX,y:J.clientY}},Z=()=>{D.isMouseDown=!1},ae=J=>{if(!D.isMouseDown)return;const pe={x:J.clientX-D.previousMousePosition.x,y:J.clientY-D.previousMousePosition.y};J.shiftKey?(D.pan.x+=pe.x*.01,D.pan.y-=pe.y*.01):(D.rotation.y+=pe.x*.01,D.rotation.x+=pe.y*.01),D.previousMousePosition={x:J.clientX,y:J.clientY}},Re=J=>{J.preventDefault(),D.zoom+=J.deltaY*-.001,D.zoom=Math.max(.1,Math.min(5,D.zoom))};I.domElement.addEventListener("mousedown",q),I.domElement.addEventListener("mouseup",Z),I.domElement.addEventListener("mousemove",ae),I.domElement.addEventListener("wheel",Re),R();const Ve=()=>{l.current=requestAnimationFrame(Ve),o.current&&(m&&!D.isMouseDown&&(o.current.rotation.y+=.005),o.current.rotation.x=D.rotation.x,o.current.rotation.y+=D.rotation.y*.1,B.position.z=5/D.zoom,B.position.x=D.pan.x,B.position.y=D.pan.y),I.render(z,B)};Ve();const Y=()=>{if(!n.current)return;const J=n.current.clientWidth,pe=n.current.clientHeight;B.aspect=J/pe,B.updateProjectionMatrix(),I.setSize(J,pe)};return window.addEventListener("resize",Y),()=>{window.removeEventListener("resize",Y),I.domElement.removeEventListener("mousedown",q),I.domElement.removeEventListener("mouseup",Z),I.domElement.removeEventListener("mousemove",ae),I.domElement.removeEventListener("wheel",Re),l.current&&cancelAnimationFrame(l.current),n.current&&I.domElement&&n.current.removeChild(I.domElement),I.dispose()}},[t,m]);const R=async()=>{try{p(!0),S(null);const z=t.fileUrl||y(t);if(console.log("Loading model from URL:",z),!z)throw new Error("No model URL available");let B;if(z.startsWith("blob:")){const ae=await fetch(z);if(!ae.ok)throw new Error(`Failed to fetch blob: ${ae.status} ${ae.statusText}`);B=await ae.text()}else{const ae=await fetch(z);if(!ae.ok)throw new Error(`Failed to load model: ${ae.status} ${ae.statusText}`);B=await ae.text()}console.log("OBJ file loaded, length:",B.length);const I=A(B);if(!I||I.attributes.position.count===0)throw new Error("Invalid model data - no vertices found");console.log("Geometry created, vertices:",I.attributes.position.count);const Q=new vy({color:6316128,side:$n,wireframe:g}),O=new ti(I,Q);I.computeBoundingBox();const V=I.boundingBox,D=V.getCenter(new j),q=V.getSize(new j);I.translate(-D.x,-D.y,-D.z);const Z=Math.max(q.x,q.y,q.z);if(Z>0){const ae=3/Z;O.scale.setScalar(ae)}o.current&&i.current.remove(o.current),o.current=O,i.current.add(O),r.current.position.set(0,0,5),r.current.lookAt(0,0,0),console.log("Model loaded successfully"),p(!1)}catch(z){console.error("Model loading error:",z),S(z.message||"Failed to load model"),p(!1)}},A=z=>{const B=[],I=[],Q=z.split(`
`);for(let V of Q)if(V=V.trim(),!(!V||V.startsWith("#"))){if(V.startsWith("v ")){const D=V.split(/\s+/);D.length>=4&&B.push(parseFloat(D[1])||0,parseFloat(D[2])||0,parseFloat(D[3])||0)}else if(V.startsWith("f ")){const D=V.split(/\s+/).slice(1);if(D.length>=3){const q=D.map(Z=>{const ae=parseInt(Z.split("/")[0])-1;return ae>=0?ae:0});for(let Z=1;Z<q.length-1;Z++)I.push(q[0],q[Z],q[Z+1])}}}if(B.length===0)throw new Error("No vertices found in OBJ file");if(I.length===0)throw new Error("No faces found in OBJ file");const O=new Ki;return O.setAttribute("position",new Vi(B,3)),O.setIndex(I),O.computeVertexNormals(),O},w=()=>{var z,B,I;d?(I=document.exitFullscreen)==null||I.call(document):(B=(z=c.current)==null?void 0:z.requestFullscreen)==null||B.call(z),h(!d)},N=()=>{const z=t.fileUrl||y(t);if(!z)return;let B=null;t.objFiles&&t.objFiles.length>0?B=t.objFiles[0].filename:t.processor==="open3d"||t.processor==="meshroom"?B="texturedMesh.obj":B=t.fileName||`${t.name}.obj`;const I=document.createElement("a");I.href=z,I.download=B,document.body.appendChild(I),I.click(),document.body.removeChild(I)},T=()=>{s.current&&(s.current.rotation={x:0,y:0},s.current.zoom=1,s.current.pan={x:0,y:0})},E=()=>{_(!g),o.current&&(o.current.material.wireframe=!g)};return v.jsx("div",{ref:c,className:"fixed inset-0 bg-black/80 flex items-center justify-center z-50",children:v.jsxs("div",{className:`relative bg-white rounded-lg shadow-xl ${d?"w-full h-full":"w-full max-w-6xl h-[80vh]"}`,children:[v.jsxs("div",{className:"flex items-center justify-between p-4 border-b bg-gray-50 rounded-t-lg",children:[v.jsx("h3",{className:"text-lg font-bold text-gray-800",children:t.name}),v.jsxs("div",{className:"flex space-x-2",children:[v.jsx("button",{onClick:()=>u(!m),title:"Toggle Auto Rotate",className:`p-2 rounded-md transition-colors ${m?"bg-blue-500 text-white":"bg-gray-200 text-gray-700"} hover:bg-blue-600`,children:v.jsx(K1,{size:18})}),v.jsx("button",{onClick:E,title:"Toggle Wireframe",className:`p-2 rounded-md transition-colors ${g?"bg-blue-500 text-white":"bg-gray-200 text-gray-700"} hover:bg-blue-600`,children:v.jsx(W1,{size:18})}),v.jsx("button",{onClick:T,title:"Reset View",className:"p-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300 transition-colors",children:v.jsx(fT,{size:18})}),v.jsx("button",{onClick:N,title:"Download",className:"p-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300 transition-colors",children:v.jsx(Np,{size:18})}),v.jsx("button",{onClick:w,title:"Toggle Fullscreen",className:"p-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300 transition-colors",children:d?v.jsx(j1,{size:18}):v.jsx(jx,{size:18})}),v.jsx("button",{onClick:e,title:"Close",className:"p-2 rounded-md bg-red-500 text-white hover:bg-red-600 transition-colors",children:v.jsx(Dp,{size:18})})]})]}),v.jsxs("div",{className:"relative w-full h-full",children:[f&&v.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-gray-100",children:v.jsxs("div",{className:"text-center",children:[v.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mb-4"}),v.jsx("p",{className:"text-gray-600",children:"Loading 3D model..."})]})}),x&&v.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-gray-100",children:v.jsxs("div",{className:"text-center",children:[v.jsx("p",{className:"text-red-600 mb-2",children:"Error loading model"}),v.jsx("p",{className:"text-gray-600 text-sm",children:x}),v.jsx("button",{onClick:R,className:"mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600",children:"Retry"})]})}),v.jsx("div",{ref:n,className:"w-full h-full",style:{cursor:(L=s.current)!=null&&L.isMouseDown?"grabbing":"grab"}}),v.jsxs("div",{className:"absolute bottom-4 left-4 bg-black/70 text-white p-3 rounded-lg text-sm",children:[v.jsx("p",{children:"• Drag to rotate"}),v.jsx("p",{children:"• Shift + Drag to pan"}),v.jsx("p",{children:"• Scroll to zoom"})]})]})]})})}function E3({generated3DModel:t,onDownload:e,onNewModel:n,onSave:i,processingTime:a,modelStats:r,isLibraryView:s=!1}){const[o,l]=G.useState(!1),[c,d]=G.useState(!0),[h,f]=G.useState(!0),[p,x]=G.useState(null),[S,m]=G.useState(!1),u=G.useRef(null),g=G.useRef(null),_=G.useRef(null),y=G.useRef(null),R=G.useRef(null),A=G.useRef(null);G.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[]);const w=z=>{if(!z||!z.id||!z.processor)return null;const B=z.processor;let I=null;return z.objFiles&&z.objFiles.length>0?I=z.objFiles[0].filename:B==="open3d"||B==="meshroom"?I="texturedMesh.obj":I=z.fileName||`${z.name}.obj`,`http://localhost:3001/models/${B}/${z.id}/${I}`};G.useEffect(()=>{if(!(!u.current||!t))return N(),T(),()=>{var z;A.current&&cancelAnimationFrame(A.current),u.current&&((z=_.current)!=null&&z.domElement)&&u.current.removeChild(_.current.domElement),_.current&&_.current.dispose()}},[t]);const N=()=>{if(!u.current)return;const z=new my;z.background=new $e(15790320),g.current=z;const B=new wn(50,u.current.clientWidth/u.current.clientHeight,.1,1e3);B.position.set(0,0,5),y.current=B;const I=new Ay({antialias:!0});I.setSize(u.current.clientWidth,u.current.clientHeight),I.shadowMap.enabled=!0,I.shadowMap.type=Lp,_.current=I,u.current.appendChild(I.domElement);const Q=new yy(4210752,.4);z.add(Q);const O=new Yc(16777215,.8);O.position.set(1,1,1),O.castShadow=!0,z.add(O);const V=new Yc(16777215,.4);V.position.set(-1,-1,-1),z.add(V);let D=!1,q=0,Z=0,ae=0,Re=0;const Ve=Me=>{D=!0,q=Me.clientX,Z=Me.clientY},Y=()=>{D=!1},J=Me=>{if(!D||!R.current)return;const be=Me.clientX-q,We=Me.clientY-Z;Re+=be*.01,ae+=We*.01,R.current.rotation.y=Re,R.current.rotation.x=ae,q=Me.clientX,Z=Me.clientY},pe=Me=>{if(!R.current)return;const We=R.current.scale.x*(1-Me.deltaY*.001);R.current.scale.setScalar(Math.max(.1,Math.min(5,We)))};I.domElement.addEventListener("mousedown",Ve),I.domElement.addEventListener("mouseup",Y),I.domElement.addEventListener("mousemove",J),I.domElement.addEventListener("wheel",pe);const le=()=>{A.current=requestAnimationFrame(le),R.current&&c&&!D&&(R.current.rotation.y+=.005),I.render(z,B)};le();const ye=()=>{if(!u.current)return;const Me=u.current.clientWidth,be=u.current.clientHeight;B.aspect=Me/be,B.updateProjectionMatrix(),I.setSize(Me,be)};window.addEventListener("resize",ye)},T=async()=>{try{f(!0),x(null);const z=w(t);if(console.log("Loading model from URL:",z),!z)throw new Error("No model URL available");let B;if(z.startsWith("blob:")){const ae=await fetch(z);if(!ae.ok)throw new Error(`Failed to fetch blob: ${ae.status} ${ae.statusText}`);B=await ae.text()}else{const ae=await fetch(z);if(!ae.ok)throw new Error(`Failed to load model: ${ae.status} ${ae.statusText}`);B=await ae.text()}console.log("OBJ file loaded, length:",B.length);const I=E(B);if(!I||I.attributes.position.count===0)throw new Error("Invalid model data - no vertices found");console.log("Geometry created, vertices:",I.attributes.position.count);const Q=new vy({color:6316128,side:$n}),O=new ti(I,Q);I.computeBoundingBox();const V=I.boundingBox,D=V.getCenter(new j),q=V.getSize(new j);I.translate(-D.x,-D.y,-D.z);const Z=Math.max(q.x,q.y,q.z);if(Z>0){const ae=3/Z;O.scale.setScalar(ae)}R.current&&g.current.remove(R.current),R.current=O,g.current.add(O),y.current.position.set(0,0,5),y.current.lookAt(0,0,0),console.log("Model loaded successfully"),f(!1)}catch(z){console.error("Model loading error:",z),x(z.message||"Failed to load model"),f(!1)}},E=z=>{const B=[],I=[],Q=z.split(`
`);for(let V of Q)if(V=V.trim(),!(!V||V.startsWith("#"))){if(V.startsWith("v ")){const D=V.split(/\s+/);D.length>=4&&B.push(parseFloat(D[1])||0,parseFloat(D[2])||0,parseFloat(D[3])||0)}else if(V.startsWith("f ")){const D=V.split(/\s+/).slice(1);if(D.length>=3){const q=D.map(Z=>{const ae=parseInt(Z.split("/")[0])-1;return ae>=0?ae:0});for(let Z=1;Z<q.length-1;Z++)I.push(q[0],q[Z],q[Z+1])}}}if(B.length===0)throw new Error("No vertices found in OBJ file");if(I.length===0)throw new Error("No faces found in OBJ file");const O=new Ki;return O.setAttribute("position",new Vi(B,3)),O.setIndex(I),O.computeVertexNormals(),O};if(!t)return v.jsx("div",{className:"w-full max-w-none mx-auto",children:v.jsx("div",{className:"bg-white rounded-2xl shadow-xl border border-gray-100",children:v.jsxs("div",{className:"p-16 text-center",children:[v.jsx("div",{className:"w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4",children:v.jsx(zd,{className:"w-8 h-8 text-gray-400"})}),v.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-2",children:"No Model Generated"}),v.jsx("p",{className:"text-gray-500 mb-6",children:"No model data available. Please generate a model first."}),v.jsx("button",{onClick:n,className:"px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium",children:"Start Creating"})]})})});const L=()=>{({...t,fileUrl:w(t)},m(!0))};return v.jsxs("div",{className:"w-full max-w-none mx-auto",children:[v.jsxs("div",{className:"bg-white rounded-2xl shadow-xl border border-gray-100",children:[v.jsx("div",{className:"border-b border-gray-200 px-8 py-6",children:v.jsxs("div",{className:"flex flex-col md:flex-row md:items-center md:justify-between gap-4",children:[v.jsxs("div",{children:[v.jsxs("div",{className:"flex items-center space-x-3 mb-2",children:[v.jsx("div",{className:"w-8 h-8 bg-green-100 rounded-full flex items-center justify-center",children:v.jsx(jc,{className:"w-5 h-5 text-green-600"})}),v.jsx("h1",{className:"text-3xl font-bold text-gray-900",children:s?"Model Preview":"3D Model Ready"})]}),v.jsxs("p",{className:"hidden sm:block text-gray-600",children:[s?"Previewing":"Your 3D model",' "',t.name,'"',s?"":" is ready for preview"]})]}),!s&&v.jsxs("button",{onClick:n,className:"hidden sm:flex items-center space-x-2 px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition font-medium w-fit",children:[v.jsx(gu,{className:"w-5 h-5"}),v.jsx("span",{children:"Generate New Model"})]})]})}),v.jsxs("div",{className:"p-8",children:[v.jsx("div",{className:"mb-8",children:v.jsxs("div",{className:"relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border-2 border-gray-200 overflow-hidden",children:[v.jsxs("div",{ref:u,className:"relative w-full h-96 bg-gradient-to-br from-gray-100 to-gray-200",children:[h&&v.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm",children:v.jsxs("div",{className:"text-center",children:[v.jsx("div",{className:"inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mb-4"}),v.jsx("p",{className:"text-gray-600",children:"Loading 3D model..."})]})}),p&&v.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm",children:v.jsxs("div",{className:"text-center",children:[v.jsx("div",{className:"w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4",children:v.jsx(zd,{className:"w-8 h-8 text-red-500"})}),v.jsx("p",{className:"text-red-600 font-medium mb-2",children:"Failed to load model"}),v.jsx("p",{className:"text-gray-500 text-sm",children:p}),v.jsx("button",{onClick:T,className:"mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600",children:"Retry"})]})})]}),v.jsx("div",{className:"hidden sm:block absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-2 shadow-lg",children:v.jsxs("div",{className:"flex items-center space-x-2 text-sm text-gray-600",children:[v.jsx("span",{children:"Click and drag to rotate"}),v.jsx("span",{children:"•"}),v.jsx("span",{children:"Scroll to zoom"})]})}),v.jsx("div",{className:"absolute bottom-4 right-4",children:v.jsx("button",{onClick:L,className:"p-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition shadow-lg",children:v.jsx(jx,{className:"w-5 h-5"})})})]})}),v.jsx("div",{className:"flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4",children:v.jsx("div",{className:"flex items-center space-x-4",children:i&&!s&&v.jsxs("button",{onClick:i,className:"flex items-center space-x-2 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-medium",children:[v.jsx(jc,{className:"w-5 h-5"}),v.jsx("span",{children:"Save to Library"})]})})})]})]}),S&&v.jsx(wy,{model:{...t,fileUrl:w(t)},onClose:()=>m(!1)})]})}function b3({savedModels:t,setSavedModels:e}){const[n,i]=G.useState(""),[a,r]=G.useState("all"),[s,o]=G.useState("newest"),[l,c]=G.useState([]),[d,h]=G.useState(null),[f,p]=G.useState(!1),x=A=>{if(!A||!A.id||!A.processor)return null;const w=A.processor;let N=null;return A.objFiles&&A.objFiles.length>0?N=A.objFiles[0].filename:w==="open3d"||w==="meshroom"?N="texturedMesh.obj":N=A.fileName||`${A.name}.obj`,`http://localhost:3001/models/${w}/${A.id}/${N}`},S=t.filter(A=>A.name.toLowerCase().includes(n.toLowerCase())&&(a==="all"||A.processor===a)).sort((A,w)=>s==="newest"?new Date(w.createdAt)-new Date(A.createdAt):s==="oldest"?new Date(A.createdAt)-new Date(w.createdAt):A.name.localeCompare(w.name)),m=A=>{switch(A){case"meshroom":return"bg-blue-100 text-blue-800";case"open3d":return"bg-green-100 text-green-800";case"import":return"bg-purple-100 text-purple-800";default:return"bg-gray-100 text-gray-800"}},u=A=>{const w=x(A);if(!w){console.error("No file URL available for model:",A);return}let N=null;A.objFiles&&A.objFiles.length>0?N=A.objFiles[0].filename:A.processor==="open3d"||A.processor==="meshroom"?N="texturedMesh.obj":N=A.fileName||`${A.name}.obj`;const T=document.createElement("a");T.href=w,T.download=N,document.body.appendChild(T),T.click(),document.body.removeChild(T)},g=async A=>{try{for(const w of A)await fetch(`http://localhost:3001/api/models/${w}`,{method:"DELETE"});e(w=>w.filter(N=>!A.includes(N.id))),c([])}catch(w){console.error("Error deleting models:",w)}},_=A=>c(w=>w.includes(A)?w.filter(N=>N!==A):[...w,A]),y=()=>{l.length===S.length?c([]):c(S.map(A=>A.id))},R=A=>{const w=x(A);if(!w){console.error("Cannot generate preview URL for model:",A);return}let N=null;A.objFiles&&A.objFiles.length>0?N=A.objFiles[0].filename:A.processor==="open3d"||A.processor==="meshroom"?N="texturedMesh.obj":N=A.fileName||`${A.name}.obj`;const T={...A,fileUrl:w,name:A.name||"Untitled Model",fileName:N,id:A.id};console.log("Preview model data:",T),console.log("Generated URL:",w),h(T),p(!0)};return v.jsxs("div",{className:"w-full max-w-none mx-auto",children:[v.jsxs("div",{className:"bg-white rounded-2xl shadow-xl border border-gray-100",children:[v.jsx("div",{className:"border-b border-gray-200 px-8 py-6",children:v.jsxs("div",{className:"flex items-center justify-between",children:[v.jsxs("div",{children:[v.jsx("h1",{className:"text-3xl font-bold text-gray-900 mb-2",children:"Model Library"}),v.jsx("p",{className:"text-gray-600",children:"Browse, preview and manage your saved 3D models"})]}),v.jsx("div",{className:"flex items-center space-x-2",children:v.jsxs("div",{className:"flex items-center space-x-1",children:[v.jsx("div",{className:"w-2 h-2 bg-green-500 rounded-full"}),v.jsx("span",{className:"text-sm text-gray-600",children:"Library View"})]})})]})}),v.jsxs("div",{className:"px-8 pt-6",children:[v.jsxs("div",{className:"flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6",children:[v.jsxs("div",{className:"relative flex-1",children:[v.jsx($1,{className:"absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5"}),v.jsx("input",{type:"text",placeholder:"Search models...",value:n,onChange:A=>i(A.target.value),className:"w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-indigo-500"})]}),v.jsxs("div",{className:"flex flex-wrap gap-2",children:[v.jsxs("select",{className:"px-4 py-3 border rounded-lg focus:ring-indigo-500",value:a,onChange:A=>r(A.target.value),children:[v.jsx("option",{value:"all",children:"All Processors"}),v.jsx("option",{value:"meshroom",children:"Meshroom"}),v.jsx("option",{value:"open3d",children:"Open3D"}),v.jsx("option",{value:"import",children:"Import"})]}),v.jsxs("select",{className:"px-4 py-3 border rounded-lg focus:ring-indigo-500",value:s,onChange:A=>o(A.target.value),children:[v.jsx("option",{value:"newest",children:"Newest First"}),v.jsx("option",{value:"oldest",children:"Oldest First"}),v.jsx("option",{value:"name",children:"Name (A-Z)"})]})]})]}),l.length>0&&v.jsxs("div",{className:"flex items-center justify-between mb-4",children:[v.jsxs("div",{className:"flex items-center space-x-4",children:[v.jsxs("button",{onClick:y,className:"flex items-center space-x-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition",children:[v.jsx("input",{type:"checkbox",checked:l.length===S.length&&S.length>0,onChange:y,className:"w-4 h-4"}),v.jsxs("span",{children:["Select All (",S.length,")"]})]}),v.jsxs("span",{className:"text-sm text-gray-600",children:[l.length," of ",S.length," selected"]})]}),v.jsxs("button",{onClick:()=>g(l),className:"flex items-center space-x-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition",children:[v.jsx(Bd,{className:"w-4 h-4"}),v.jsxs("span",{children:["Delete Selected (",l.length,")"]})]})]}),S.length===0?v.jsxs("div",{className:"text-center py-16",children:[v.jsx(kx,{className:"w-16 h-16 text-gray-400 mx-auto mb-4"}),v.jsx("p",{className:"text-gray-600",children:n||a!=="all"?"No models match your search":"No models found"})]}):v.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pb-8",children:S.map(A=>v.jsxs("div",{className:`rounded-xl p-4 border transition-all ${l.includes(A.id)?"bg-blue-50 border-blue-300 shadow-md":"bg-gray-50 border-gray-200 hover:shadow-md"}`,children:[v.jsxs("div",{className:"flex items-center justify-between mb-3",children:[v.jsxs("div",{className:"flex items-center space-x-2",children:[v.jsx("input",{type:"checkbox",checked:l.includes(A.id),onChange:()=>_(A.id),className:"w-4 h-4 text-blue-600 rounded focus:ring-blue-500"}),v.jsx("h3",{className:"font-semibold truncate text-gray-900",children:A.name})]}),v.jsx("span",{className:`text-xs px-2 py-1 rounded font-medium ${m(A.processor)}`,children:A.processor})]}),v.jsxs("div",{className:"text-gray-500 text-xs mb-4",children:["Created: ",new Date(A.createdAt).toLocaleDateString()]}),v.jsxs("div",{className:"flex space-x-2",children:[v.jsxs("button",{onClick:()=>u(A),className:"flex-1 flex items-center justify-center space-x-1 bg-indigo-600 text-white px-3 py-2 rounded-lg text-sm hover:bg-indigo-700 transition",children:[v.jsx(Np,{className:"w-4 h-4"}),v.jsx("span",{children:"Download"})]}),v.jsxs("button",{onClick:()=>R(A),className:"flex-1 flex items-center justify-center space-x-1 bg-gray-600 text-white px-3 py-2 rounded-lg text-sm hover:bg-gray-700 transition",children:[v.jsx(O1,{className:"w-4 h-4"}),v.jsx("span",{children:"Preview"})]})]})]},A.id))})]})]}),f&&d&&v.jsx(wy,{model:d,onClose:()=>{p(!1),h(null)}})]})}function T3(){const[t,e]=G.useState("images"),[n,i]=G.useState([]),[a,r]=G.useState([]),[s,o]=G.useState(""),[l,c]=G.useState("meshroom"),[d,h]=G.useState(!1),[f,p]=G.useState(0),[x,S]=G.useState(null),[m,u]=G.useState([]),[g,_]=G.useState(!1),[y,R]=G.useState(null),[A,w]=G.useState("generate"),[N,T]=G.useState(!1),E=["Analyzing image quality...","Detecting features...","Computing depth maps...","Reconstructing point cloud...","Generating mesh...","Applying textures...","Optimizing model...","Finalizing export..."],L=async()=>{if(g)try{const q=await fetch("http://localhost:3001/api/models");if(q.ok){const Z=await q.json();u(Z)}}catch(q){console.error("Failed to fetch models:",q)}};G.useEffect(()=>{fetch("http://localhost:3001/api/health").then(q=>q.ok?_(!0):_(!1)).catch(()=>_(!1))},[]),G.useEffect(()=>{g&&L()},[g]);const z=()=>{if(!(t==="images"&&n.length>=2||t==="import"&&a.length>0)){R(t==="images"?"Upload at least 2 images":"Upload at least 1 OBJ file");return}T(!0)},B=async()=>{var q,Z,ae,Re,Ve,Y;if(!g)return R("Backend unavailable");h(!0),R(null),p(0);try{const J=new FormData;n.forEach(U=>J.append("images",U.file)),a.forEach(U=>J.append("objFiles",U.file)),s&&J.append("modelName",s),J.append("processor",l);const{modelId:pe}=await(await fetch("http://localhost:3001/api/upload",{method:"POST",body:J})).json();let le="processing",ye=0;for(;le==="processing"||le==="queued";){p(Math.min(ye,E.length-1)),await new Promise(Qe=>setTimeout(Qe,2e3));const{status:U,error:jt}=await(await fetch(`http://localhost:3001/api/models/${pe}/status`)).json();if(le=U,jt)throw new Error(jt);ye++}const Me=await(await fetch(`http://localhost:3001/api/models/${pe}`)).json(),be=await I(pe),We=be.find(U=>["obj","stl","ply"].includes(U.extension)),vt=We?`http://localhost:3001/models/${l}/${pe}/${We.name}`:null,Ke={id:pe,name:Me.name||s||`Model_${Date.now()}`,fileUrl:vt,format:((q=We==null?void 0:We.extension)==null?void 0:q.toUpperCase())||null,files:be,thumbnail:(ae=(Z=Me.images)==null?void 0:Z[0])!=null&&ae.filename?`http://localhost:3001/uploads/${Me.images[0].filename}`:((Re=n[0])==null?void 0:Re.url)||"/placeholder-3d.png",createdAt:new Date().toISOString(),imageCount:((Ve=Me.images)==null?void 0:Ve.length)||n.length,objCount:((Y=Me.objFiles)==null?void 0:Y.length)||a.length,processor:Me.processor,type:Me.processor==="import"?"import":"images",objFiles:Me.objFiles||[],vertices:Me.vertices||0,triangles:Me.triangles||0,sizeX:Me.sizeX||0,sizeY:Me.sizeY||0,sizeZ:Me.sizeZ||0,size:(We==null?void 0:We.size)||0};S(Ke),L()}catch(J){R(J.message||"Processing failed")}finally{h(!1)}},I=async q=>{try{const{files:Z}=await(await fetch(`http://localhost:3001/api/models/${q}/files`)).json();return Z||[]}catch{return[]}},Q=()=>{i([]),r([]),o(""),S(null),T(!1),R(null),h(!1),p(0),w("generate")},O=()=>Q(),V=()=>{var q;if(x!=null&&x.fileUrl){const Z=document.createElement("a");Z.href=x.fileUrl,Z.download=`${x.name}.${(q=x.format)==null?void 0:q.toLowerCase()}`,Z.click()}},D=q=>{w(q),q==="library"?(L(),S(null)):q==="generate"&&Q()};return v.jsxs("div",{className:"max-w-7xl mx-auto p-4 md:p-6 space-y-6",children:[v.jsx("nav",{className:"bg-white rounded-xl shadow-lg p-2 mb-8 border",children:v.jsxs("div",{className:"flex space-x-2",children:[v.jsxs("button",{onClick:()=>D("generate"),className:`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${A==="generate"?"bg-purple-600 text-white":"text-gray-700 hover:bg-gray-100"}`,children:[v.jsx(gu,{className:"w-5 h-5 mr-2 inline"})," Generate"]}),v.jsxs("button",{onClick:()=>D("library"),className:`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${A==="library"?"bg-green-600 text-white":"text-gray-700 hover:bg-gray-100"}`,children:[v.jsx(kx,{className:"w-5 h-5 mr-2 inline"})," Library (",m.length,")"]})]})}),!g&&v.jsx(Dg,{type:"warning",message:"Backend not available."}),y&&v.jsx(Dg,{type:"error",message:y,onClose:()=>R(null)}),A==="generate"&&v.jsxs(v.Fragment,{children:[!N&&!x&&v.jsx(mT,{selectedImages:n,setSelectedImages:i,selectedObjFiles:a,setSelectedObjFiles:r,uploadType:t,setUploadType:e,error:y,setError:R,onNext:z}),N&&!x&&v.jsx(gT,{selectedImages:n,selectedObjFiles:a,uploadType:t,modelName:s,setModelName:o,processor:l,setProcessor:c,isProcessing:d,processingStep:f,processingSteps:E,handleGenerate:B}),x&&v.jsx(E3,{generated3DModel:x,onDownload:V,onNewModel:O})]}),A==="library"&&v.jsx(b3,{savedModels:m,setSavedModels:u,setActiveTab:w,setError:R,onRefresh:L})]})}function A3(){return v.jsxs("div",{className:"min-h-screen flex flex-col",children:[v.jsx(dT,{}),v.jsx("div",{className:"flex-grow",children:v.jsxs(Ub,{children:[v.jsx(Od,{path:"/",element:v.jsx(pT,{})}),v.jsx(Od,{path:"/generate",element:v.jsx(T3,{})})]})}),v.jsx(hT,{})]})}DE.createRoot(document.getElementById("root")).render(v.jsx(n1,{basename:"/snap3d",children:v.jsx(A3,{})}));
